...
INSERT INTO `tb_barang` (`id`,`sai`,`kode`,`nama`,`unit`,`harga`,`jumlah`,`created_at`,`updated_at`) VALUES 
 ...
 (24,'SAI-190513-0011','ET.0189.0008','Bale Label Sampoerna A Volution 100g DHX 20 SSL (63.G068)','PCS',3423423,80000,NULL,NULL),
 (25,'SAI-190513-0011','','Bale Label Sampoerna A Volution 100g DHX 20 SSL (63.G068)','',3423,3500,NULL,NULL),
 (26,'SAB-200203-0001','K.060.0400.PLN.082','DPC 400 / 69.5 x 91.5 LG -- IK','RIM',421312,40,NULL,NULL),
 (27,'SAB-200203-0001','K.060.0400.PLN.082','DPC 400 / 69.5 x 91.5 LG -- IK','RIM',5234,3,NULL,NULL),
 (28,'SAB-200218-0002','BP.001.190','PLATE ACHIEVE EM 1030x770x0.30 -30 CD4','LBR',2431241,0,NULL,NULL);
INSERT INTO `tb_barang` (`id`,`sai`,`kode`,`nama`,`unit`,`harga`,`jumlah`,`created_at`,`updated_at`) VALUES 
...
INSERT INTO `tb_saim` (`id`,`sai`,`KodeCus`,`NamaCus`,`printed`,`CreatedDate`,`ApprovedBy`,`CreatedBy`,`ChangedDate`,`ChangedBy`,`arc`,`ard`,`created_at`,`updated_at`,`status_docs`) VALUES 
 (8,'SAA-191030-0001','','PT. Imperial Nusantara','DELETED','','ffitrotul','mwaluyo','2021-08-20','Arrix Pradana Frima',NULL,NULL,NULL,'2021-08-23 07:41:32','dissaproved'),
 (9,'SAI-190513-0011','SUB.0189','PT. Hanjaya Mandala Sampoerna Tbk','PAID','','unknown','sutami','2019-06-26 15:25:04','Arrix Pradana Frima',NULL,NULL,NULL,'2021-08-23 07:43:05','dissaproved'),
 (12,'SAB-200203-0001','BKA.0028','PT. Serunigraf Jaya Sentosa','PAID','','ffitrotul','mwaluyo','2020-02-04 11:09:15','Arrix Pradana Frima',NULL,NULL,NULL,'2021-08-23 07:42:50','approved'),
 (13,'SAB-200218-0002','SUB.0213','CV. Gemilang Multi Kreasi','PAID','','ffitrotul','sutami','2020-02-19 16:13:41','Mita Wahyu Waluyo',NULL,NULL,NULL,'2021-08-23 09:29:56','approved');
...
INSERT INTO `users` (`id`,`name`,`email`,`email_verified_at`,`password`,`remember_token`,`created_at`,`updated_at`,`user_sim`) VALUES 
 (5,'Daniel','daniel@staff.co.id',NULL,'$2y$10$lDiDUGfqEMGVrWyJe1Qg3eO6zDMKvFRvaJW/acW1tL2n1gsTMDR5m',NULL,'2021-08-03 06:10:02','2021-08-03 06:10:02','dsetyawan'),
 (6,'EDP','edp@krisanthium.com',NULL,'$2y$10$GsJOjfmLTVgRlX2TtRknjO6xi2XP.44finZWB88Zdwib8CWXCnvp.',NULL,'2021-08-03 07:09:38','2021-08-03 07:09:38','EDP'),
 (7,'Arrix Pradana Frima','head@finance.tech',NULL,'$2y$10$TRntJZkE2LFp1LqvJaV1PeHKXP4pdeUC.VdpCp/NaH72tCWQHgsuS',NULL,'2021-08-20 01:53:24','2021-08-20 01:53:24','afrima'),
 (8,'Ratna Yani Astuty','manager@finance.tech',NULL,'$2y$10$7PP8vdgQd56yi4Xo2n7S6exS9KWRj/dwiruvv.kFCVts5vNEqoUxy',NULL,'2021-08-20 01:54:23','2021-08-20 01:54:23','rastuty'),
 (9,'Mita Wahyu Waluyo','staff@finance.tech',NULL,'$2y$10$mEaUyzEWHr12a970dcfUnecCmB8Wzal7ahbBXkQqAoqfxuEgsG54a',NULL,'2021-08-20 01:55:23','2021-08-20 01:55:23','mwaluyo');
