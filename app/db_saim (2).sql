...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2021 at 05:16 AM
...
CREATE TABLE `history_pui` (
  ...
  `pui` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `user_sim` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
(13, 'SAB-200203-0001', 'K.060.0400.PLN.082', 'DPC 400 / 69.5 x 91.5 LG -- IK', 'RIM', 0, 0, NULL, NULL),
...
(18, 'SAA-191030-0001', 'BP.001.338', 'PLATE AGFA AIYINDA 1030mm x800mm-50', 'LBR', 0, 83928932, NULL, NULL);
...
CREATE TABLE `tb_po` (
  `id` int(10) UNSIGNED NOT NULL,
  `id_sai` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(23, 'SAA-191030-0001', '1910-163', NULL),
(24, 'SAA-191030-0001', 'POSD-20121', NULL);
...
(7, 'SAB-200203-0001', '', 'PT. Serunigraf Jaya Sentosa', 'PAID', '', 'ffitrotul', 'mwaluyo', '2021-08-10', 'daniel staff', NULL, NULL, NULL, '2021-08-10 02:51:48'),
(8, 'SAA-191030-0001', '', 'PT. Imperial Nusantara', 'DELETED', '', 'ffitrotul', 'mwaluyo', '2021-08-10', 'daniel staff', NULL, NULL, NULL, '2021-08-10 03:00:02');
