...
class StoredImageFour implements StoredDocumentFOURInterface
{
    ...
    public function StoredDocumentComponentOrdersFOUR(Object $request, $generateID, $generateIDNEXT) {
        $data = array();    
                    ...
                    if ($request->hasFile('files'.$x)) 
                        {
                            ...
                            $file->design_plan = isset($request->lastIndex) ? "cp".$request->lastIndex : $request->design4;
