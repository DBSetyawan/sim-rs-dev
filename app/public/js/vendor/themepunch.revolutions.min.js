    ...
    var checkActions_intern = function (_nc, opt, as) {
        ...
        getOffContH = function (e) {
            ...
            if (e.split(",").length > 1) {
                oc = e.split(",");
                var a = 0;
                return oc && jQuery.each(oc, function (e, t) {
...
! function () {
    ...
    jQuery.extend(!0, i, {
        ...
        carouselToEvalPosition: function (e, t) {
            ...
            var l = "center" === o.horizontal_align ? (o.wrapwidth / 2 - o.slide_width / 2 - o.slide_globaloffset) / o.slide_width : (0 - o.slide_globaloffset) / o.slide_width,
                ...
                f = -1 * (Math.ceil(r) - r),
                h = -1 * (Math.floor(r) - r);
            d = n >= .3 && "left" === t || n >= .7 && "right" === t ? f : .3 > n && "left" === t || .7 > n && "right" === t ? h : d, d = "off" === o.infinity ? 0 > r ? r : l > e.slideamount - 1 ? l - (e.slideamount - 1) : d : d, o.slide_offset_target = d * o.slide_width, 0 !== Math.abs(o.slide_offset_target) ? s(e, t, !0) : i.organiseCarousel(e, t)
        },
        organiseCarousel: function (i, e, t, a) {
            ...
            for (var s = i.carousel, o = new Array, l = s.slides.length, r = "right" === s.horizontal_align ? r = i.width : 0, n = 0; l > n; n++) {
                ...
                "on" === s.infinity && (d = d > s.wrapwidth - s.inneroffset && "right" == e ? s.slide_offset - (s.slides.length - n) * s.slide_width : d, d = d < 0 - s.inneroffset - s.slide_width && "left" == e ? d + s.maxwidth : d), o[n] = d
            }
            var f = 999;
            s.slides && jQuery.each(s.slides, function (i, a) {
                var r = o[i];
                "on" === s.infinity && (r = r > s.wrapwidth - s.inneroffset && "left" === e ? o[0] - (l - i) * s.slide_width : r, r = r < 0 - s.inneroffset - s.slide_width ? "left" == e ? r + s.maxwidth : "right" === e ? o[l - 1] + (i + 1) * s.slide_width : r : r);
                var n = new Object;
                ...
                if ((t && Math.abs(d) < f || 0 === d) && (f = Math.abs(d), s.focused = i), n.width = s.slide_width, n.x = 0, n.transformPerspective = 1200, n.transformOrigin = "50% " + s.vertical_align, "on" === s.fadeout)
                ...
                if (void 0 !== s.minScale && s.minScale > 0)
                    ...
                    } void 0 !== s.maxRotation && 0 != Math.abs(s.maxRotation) && ("on" === s.vary_rotation ? (n.rotationY = Math.abs(s.maxRotation) - Math.abs((1 - Math.abs(1 / Math.ceil(s.maxVisibleItems / h) * d)) * s.maxRotation), n.autoAlpha = Math.abs(n.rotationY) > 90 ? 0 : n.autoAlpha) : n.rotationY = d >= 1 || -1 >= d ? s.maxRotation : Math.abs(d) * s.maxRotation, n.rotationY = 0 > d ? -1 * n.rotationY : n.rotationY), n.x = -1 * s.space * d, n.left = Math.floor(n.left), n.x = Math.floor(n.x), void 0 !== n.scale ? 0 > d ? n.x - w : n.x + w : n.x, n.zIndex = Math.round(100 - Math.abs(5 * d)), n.transformStyle = "flat", punchgs.TweenLite.set(a, n)
    ...
    var e = function (i) {
            var e = i.carousel;
            e.infbackup = e.infinity, e.maxVisiblebackup = e.maxVisibleItems, e.slide_globaloffset = "none", e.slide_offset = 0, e.wrap = i.c.find(".tp-carousel-wrapper"), e.slides = i.c.find(".tp-revslider-slidesli"), 0 !== e.maxRotation && punchgs.TweenLite.set(e.wrap, {
                perspective: 1200,
                transformStyle: "flat"
            }), void 0 !== e.border_radius && parseInt(e.border_radius, 0) > 0 && punchgs.TweenLite.set(i.c.find(".tp-revslider-slidesli"), {
        ...
        t = function (t) {
            ...
            void 0 === a.wrap && e(t), a.slide_width = "on" !== a.stretch ? t.gridwidth[t.curWinRange] * t.bw : t.c.width(), a.maxwidth = t.slideamount * a.slide_width, a.maxVisiblebackup > a.slides.length + 1 && (a.maxVisibleItems = a.slides.length + 2), a.wrapwidth = a.maxVisibleItems * a.slide_width + (a.maxVisibleItems - 1) * a.space, a.wrapwidth = "auto" != t.sliderLayout ? a.wrapwidth > t.c.closest(".tp-simpleresponsive").width() ? t.c.closest(".tp-simpleresponsive").width() : a.wrapwidth : a.wrapwidth > t.ul.width() ? t.ul.width() : a.wrapwidth, a.infinity = a.wrapwidth >= a.maxwidth ? "off" : a.infbackup, a.wrapoffset = "center" === a.horizontal_align ? (t.c.width() - o - s - a.wrapwidth) / 2 : 0, a.wrapoffset = "auto" != t.sliderLayout && t.outernav ? 0 : a.wrapoffset < s ? s : a.wrapoffset, "right" === a.horizontal_align ? punchgs.TweenLite.set(a.wrap, {
                left: "auto",
        ...
        s = function (e, t, s) {
            ...
            t = o.lastdirection = a(t, o.lastdirection);
            var l = new Object;
            l.from = 0, l.to = o.slide_offset_target, void 0 !== o.positionanim && o.positionanim.pause(), o.positionanim = punchgs.TweenLite.to(l, 1.2, {
                from: l.to,
                onUpdate: function () {
                    o.slide_offset = o.slide_globaloffset + l.from, o.slide_offset = i.simp(o.slide_offset, o.maxwidth), i.organiseCarousel(e, t, !1, !1)
                },
                onComplete: function () {
                    o.slide_globaloffset = "off" === o.infinity ? o.slide_globaloffset + o.slide_offset_target : i.simp(o.slide_globaloffset + o.slide_offset_target, o.maxwidth), o.slide_offset = i.simp(o.slide_offset, o.maxwidth), i.organiseCarousel(e, t, !1, !0);
    ...
    jQuery.extend(!0, t, {
                ...
                case "vimeo":
                    if (0 == o.find("iframe").length) o.append(o.data("videomarkup")), d(o, n, !0);
                        ...
                        void 0 == p.api("play") ? o.data("videoplaywait", setTimeout(function () {
                            ...
                            p.api("play");
                            var t = e(o.data("videostartat")); - 1 != t && p.api("seekTo", t)
                        }, 510)
                    } else o.data("videoplaywait", setTimeout(function () {
                        t.playVideo(o, n)
                    }, 50));
        ...
        prepareCoveredVideo: function (e, t, a) {
            var i = a.find("iframe, video"),
                ...
                s = n / r * 100,
                p = r / n * 100;
            n > r ? punchgs.TweenLite.to(i, .001, {
                height: s + "%",
                width: "100%",
                top: -(s - 100) / 2 + "%",
                left: "0px",
        ...
        manageVideoLayer: function (o, r) {
            ...
            switch (o.data("videotype", y), w) {
                case "html5":
                    ...
                    void 0 != c && "firefox" == t.get_browser().toLowerCase() && (b = b + '<source src="' + c + '" type="video/webm" />'), void 0 != u && (b = b + '<source src="' + u + '" type="video/mp4" />'), void 0 != f && (b = b + '<source src="' + f + '" type="video/ogg" />'), b += "</video>", "controls" == m && (b += '<div class="tp-video-controls"><div class="tp-video-button-wrap"><button type="button" class="tp-video-button tp-vid-play-pause">Play</button></div><div class="tp-video-seek-bar-wrap"><input  type="range" class="tp-seek-bar" value="0"></div><div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-mute">Mute</button></div><div class="tp-video-vol-bar-wrap"><input  type="range" class="tp-volume-bar" min="0" max="1" step="0.1" value="1"></div><div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-full-screen">Full-Screen</button></div></div>'), o.data("videomarkup", b), o.append(b), (a && 1 == o.data("disablevideoonmobile") || t.isIE(8)) && o.find("video").remove(), o.find("video").each(function () {
                        var e = this,
                            a = jQuery(this);
                ...
                case "youtube":
                    ...
                    var k = e(o.data("videostartat")),
                        T = e(o.data("videoendat")); - 1 != k && (s = s + "&start=" + k), -1 != T && (s = s + "&end=" + T);
                    var x = s.split("origin=" + h + "://"),
                        L = "";
                    x.length > 1 ? (L = x[0] + "origin=" + h + "://", self.location.href.match(/www/gi) && !x[1].match(/www/gi) && (L += "www."), L += x[1]) : L = s, o.data("videomarkup", '<iframe style="visible:hidden" src="' + h + "://www.youtube.com/embed/" + p + "?" + L + '" width="100%" height="100%" style="width:100%;height:100%"></iframe>');
                    break;
                case "vimeo":
                    "https:" === location.protocol && (h = "https"), o.data("videomarkup", '<iframe style="visible:hidden" src="' + h + "://player.vimeo.com/video/" + l + "?" + s + '" width="100%" height="100%" style="100%;height:100%"></iframe>')
            }
            ...
            })) : 0 != o.find("iframe").length || "youtube" != y && "vimeo" != y || (o.append(o.data("videomarkup")), d(o, r, !1)), "none" != o.data("dottedoverlay") && void 0 != o.data("dottedoverlay") && 1 != o.find(".tp-dottedoverlay").length && o.append('<div class="tp-dottedoverlay ' + o.data("dottedoverlay") + '"></div>'), o.addClass("HasListener"), 1 == o.data("bgvideo") && punchgs.TweenLite.set(o.find("video, iframe"), {
                autoAlpha: 0
            })
        }
    });
                        ...
                        events: {
                            onStateChange: function (t) {
                                ...
                                if (t.data == YT.PlayerState.PLAYING) punchgs.TweenLite.to(p.find(".tp-videoposter"), .3, {
                                    ...
                                    display: "block",
                                    ease: punchgs.Power3.easeInOut
                                }), "mute" == p.data("volume") ? l.mute() : (l.unMute(), l.setVolume(parseInt(p.data("volume"), 0) || 75)), d.videoplaying = !0, r(p, d), n.trigger("stoptimer"), d.c.trigger("revolution.slide.onvideoplay", o(l, "youtube", p.data()));
                                else {
                                    if (0 == t.data && v) {
                                        var u = e(p.data("videostartat")); - 1 != u && l.seekTo(u), l.playVideo()
        ...
        n = function (d, n) {
            ...
            void 0 != m && (i(m, "click", function () {
                ...
                if (y.value = t, 0 != a && Math.abs(a - i) <= .3 && a > i && 1 != d.data("nextslidecalled"))
                    if (u) {
                        l.play();
                        var o = e(d.data("videostartat")); - 1 != o && (l.currentTime = o)
