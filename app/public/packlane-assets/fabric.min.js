...
'undefined' != typeof exports && (exports.fabric = fabric),
  ...
  (function() {
    function t(t, e) {
      this.__eventListeners[t] &&
        (e
          ? fabric.util.removeFromArray(this.__eventListeners[t], e)
          : (this.__eventListeners[t].length = 0));
    }
    function e(t, e) {
  ...
  (fabric.Collection = {
    ...
    remove: function() {
      for (var t, e = this.getObjects(), i = 0, r = arguments.length; r > i; i++)
        (t = e.indexOf(arguments[i])),
          -1 !== t && (e.splice(t, 1), this._onObjectRemoved(arguments[i]));
      return this.renderOnAddRemove && this.renderAll(), this;
    },
  ...
  (function(t) {
    ...
    fabric.util = {
      ...
      resolveNamespace: function(e) {
        if (!e) return fabric;
        for (var i = e.split('.'), r = i.length, n = t || fabric.window, s = 0; r > s; ++s)
          n = n[i[s]];
        return n;
      },
      ...
      isTransparent: function(t, e, i, r) {
        ...
        for (
          var n = !0, s = t.getImageData(e, i, 2 * r || 1, 2 * r || 1), o = 3, a = s.data.length;
          a > o;
          o += 4
        ) {
          var h = s.data[o];
      ...
      parsePreserveAspectRatioAttribute: function(t) {
        ...
        return (
          s &&
            s.length &&
            ((i = s.pop()),
            'meet' !== i && 'slice' !== i ? ((e = i), (i = 'meet')) : s.length && (e = s.pop())),
  ...
  (function() {
    function t(t, r, s, o, h, c, l) {
      ...
      for (
        var D = Math.ceil(Math.abs((L / f) * 2)),
          I = [],
          E = L / D,
          F = ((8 / 3) * Math.sin(E / 4) * Math.sin(E / 4)) / Math.sin(E / 2),
          R = P + E,
          B = 0;
        D > B;
        B++
      )
        (I[B] = e(P, R, p, g, s, o, A, M, F, v, b)),
          (v = I[B][4]),
          (b = I[B][5]),
          (P = R),
          (R += E);
        ...
        if (
          ...
          (b = f * f - 4 * d * u),
            0 > b ||
              ...
              (v = (-f - m) / (2 * u)),
              v > 0 && 1 > v && C.push(v));
      for (var T, k, j, A = C.length, M = A; A--; )
        (g = C[A]),
          (j = 1 - g),
    ...
    (fabric.util.drawArc = function(e, i, r, n) {
      ...
      (fabric.util.getBoundsOfArc = function(e, i, n, s, o, a, h, c, l) {
        for (
          ...
          (d = r(u, f, p[b][0], p[b][1], p[b][2], p[b][3], p[b][4], p[b][5])),
            (v[0].x = d[0].x + e),
            (v[0].y = d[0].y + i),
            (v[1].x = d[1].x + e),
            (v[1].y = d[1].y + i),
  ...
  (function() {
    function t(t, e) {
      for (var i = n.call(arguments, 2), r = [], s = 0, o = t.length; o > s; s++)
        r[s] = i.length ? t[s][e].apply(t[s], i) : t[s][e].call(t[s]);
      return r;
    }
    function e(t, e) {
    ...
    Array.prototype.indexOf ||
      ...
      Array.prototype.map ||
        (Array.prototype.map = function(t, e) {
          for (var i = [], r = 0, n = this.length >>> 0; n > r; r++)
      ...
      Array.prototype.filter ||
        (Array.prototype.filter = function(t, e) {
          for (var i, r = [], n = 0, s = this.length >>> 0; s > n; n++)
  ...
  (function() {
    ...
    function r(t, e) {
      return function(i) {
        if (p[t] && p[t][e])
          for (var r = p[t][e], n = 0, s = r.length; s > n; n++)
        ...
        ? ((l = function(t, i, r) {
          ...
          (u = function(t, e, i) {
            var r,
              n = c(t);
            if (g[n] && g[n][e])
              for (var s = 0, o = g[n][e].length; o > s; s++)
                (r = g[n][e][s]),
                  r &&
                    r.handler === i &&
                    (t.detachEvent('on' + e, r.wrappedHandler), (g[n][e][s] = null));
          }))
        : ((l = function(t, e, i) {
            var n = c(t);
            if ((p[n] || (p[n] = {}), !p[n][e])) {
  ...
  (function() {
    ...
    (l =
      ...
      (function() {
        function t(t) {
          return (
            'undefined' != typeof t.onselectstart && (t.onselectstart = fabric.util.falseFunction),
            r
              ? (t.style[r] = 'none')
  ...
  (function() {
    ...
    function i(i, n) {
      ...
      return (
        ...
        'GET' === o && ((s = null), 'string' == typeof n.parameters && (i = t(i, n.parameters))),
        h.open(o, i, !0),
        ('POST' === o || 'PUT' === o) &&
        ...
        t.onStart && t.onStart(),
          (function d(i) {
            ...
            return h()
              ...
              : (a(c(u, l, f, s)), r > o ? void (t.onComplete && t.onComplete()) : void e(d));
          })(n);
      });
    }
    function e() {
  ...
  (function() {
    function t(t, e, i, r) {
      return (
        t < Math.abs(e) ? ((t = e), (r = i / 4)) : (r = (i / (2 * Math.PI)) * Math.asin(e / t)),
        { a: t, c: e, p: i, s: r }
      );
    }
    function e(t, e, i) {
    ...
    function o(t, e, i, r) {
      return (
        (t /= r / 2),
        1 > t ? (i / 2) * t * t * t * t + e : (-i / 2) * ((t -= 2) * t * t * t - 2) + e
      );
    }
    function a(t, e, i, r) {
    ...
    function c(t, e, i, r) {
      return (
        (t /= r / 2),
        1 > t ? (i / 2) * t * t * t * t * t + e : (i / 2) * ((t -= 2) * t * t * t * t + 2) + e
      );
    }
    function l(t, e, i, r) {
      return -i * Math.cos((t / r) * (Math.PI / 2)) + i + e;
    ...
    function k(t, e, i, r) {
      return r / 2 > t ? 0.5 * O(2 * t, 0, i, r) + e : 0.5 * T(2 * t - r, 0, i, r) + 0.5 * i + e;
    }
    fabric.util.ease = {
  ...
  (function(t) {
        ...
        ('fill' !== t && 'stroke' !== t) || 'none' !== e
          ? 'strokeDashArray' === t
            ...
            : 'transformMatrix' === t
              ? (e =
                  i && i.transformMatrix
                    ? x(i.transformMatrix, p.parseTransformAttribute(e))
                    : p.parseTransformAttribute(e))
              : 'visible' === t
                ? ((e = 'none' === e || 'hidden' === e ? !1 : !0),
                  i && i.visible === !1 && (e = !1))
                : 'originX' === t
    ...
    function o(t, e) {
      ...
      for (var r in p.cssRules[e])
        if (a(t, r.split(' '))) for (var n in p.cssRules[e][r]) i[n] = p.cssRules[e][r][n];
      return i;
    }
    function a(t, e) {
      var i,
    ...
    function h(t, e) {
      for (var i, r = !0; t.parentNode && 1 === t.parentNode.nodeType && e.length; )
        r && (i = e.pop()), (t = t.parentNode), (r = c(t, i));
      return 0 === e.length;
    }
    function c(t, e) {
      var i,
      ...
      if (
        ...
        s &&
          e.length &&
          ((i = new RegExp('#' + s + '(?![a-zA-Z\\-]+)', 'i')), (e = e.replace(i, ''))),
        n && e.length)
      ) {
        n = n.split(' ');
    ...
    function u(t) {
      for (var e = t.getElementsByTagName('use'), i = 0; e.length && i < e.length; ) {
        ...
        if ((f(g), /^svg$/i.test(g.nodeName))) {
          ...
          for (s = 0, o = g.attributes, a = o.length; a > s; s++)
            (n = o.item(s)), b.setAttribute(n.nodeName, n.nodeValue);
          for (; null != g.firstChild; ) b.appendChild(g.firstChild);
          g = b;
        }
        for (s = 0, o = h.attributes, a = o.length; a > s; s++)
          (n = o.item(s)),
            'x' !== n.nodeName &&
              'y' !== n.nodeName &&
              'xlink:href' !== n.nodeName &&
              ('transform' === n.nodeName
                ? (p = n.nodeValue + ' ' + p)
                : g.setAttribute(n.nodeName, n.nodeValue));
    ...
    function f(t) {
      ...
      if (
        ...
        b
          ...
          : ((y.width = _(l)), (y.height = _(u)), (o = y.width / e), (a = y.height / i)),
      ...
      if (
        ...
        (r = x + ' matrix(' + o + ' 0 0 ' + a + ' ' + h * o + ' ' + c * a + ') '),
        'svg' === t.tagName)
      ) {
        for (n = t.ownerDocument.createElement('g'); null != t.firstChild; )
      ...
      (p.parseTransformAttribute = (function() {
        ...
        return function(o) {
          ...
          for (var c = h[0]; h.length > 1; )
            h.shift(), (c = p.util.multiplyTransformMatrices(c, h[0]));
          return c;
        };
      })());
    var j = new RegExp(
    ...
    p.parseSVGDocument = (function() {
      ...
      return function(e, i, r) {
        if (e) {
          ...
          (p.gradientDefs[s] = p.getGradientDefs(e)),
            (p.cssRules[s] = p.getCSSRules(e)),
            p.parseElements(
              d,
              function(t) {
    ...
    v(p, {
      ...
      getGradientDefs: function(t) {
        var e,
          ...
          r,
          n,
          s = t.getElementsByTagName('linearGradient'),
      ...
      parseAttributes: function(t, n, s) {
        if (t) {
          ...
          'undefined' == typeof s && (s = t.getAttribute('svgUid')),
            t.parentNode &&
              O.test(t.parentNode.nodeName) &&
              (c = p.parseAttributes(t.parentNode, n, s)),
            (h = (c && c.fontSize) || t.getAttribute('font-size') || p.Text.DEFAULT_SVG_FONT_SIZE);
          var l = n.reduce(function(r, n) {
            return (a = t.getAttribute(n)), a && ((n = e(n)), (a = i(n, a, c, h)), (r[n] = a)), r;
          }, {});
          return (
            (l = v(l, v(o(t, s), p.parseStyleAttribute(t)))),
            l.font && p.parseFontDeclaration(l.font, l),
            r(v(c, l))
          );
        }
      },
          ...
          n &&
            ...
            n &&
              ...
              p.parseSVGDocument(
                n.documentElement,
                function(i, r) {
                  A.set(t, { objects: p.util.array.invoke(i, 'toObject'), options: r }), e(i, r);
                },
                i,
              );
        }
      ...
      createSVGFontFacesMarkup: function(t) {
        ...
        return (
          e && (e = ['  <style type="text/css">', '<![CDATA[', e, ']]>', '</style>\n'].join('')), e
        );
      },
  ...
  (fabric.ElementsParser.prototype.resolveGradient = function(t, e) {
    ...
    if (/^url\(/.test(i)) {
      ...
      fabric.gradientDefs[this.svgUid][r] &&
        t.set(e, fabric.Gradient.fromElement(fabric.gradientDefs[this.svgUid][r], t));
    }
  }),
          ...
          if (0 !== c) {
            ...
            l >= 0 && 1 >= l && u >= 0 && 1 >= u
              ? ((o = new e('Intersection')),
                o.points.push(new i.Point(t.x + l * (r.x - t.x), t.y + l * (r.y - t.y))))
              : (o = new e());
    ...
    return r.Color
      ...
      : ((r.Color = e),
        (r.Color.prototype = {
          _tryParsingColor: function(t) {
            ...
            return (
              ...
              'transparent' === t
                ? void this.setSource([255, 255, 255, 0])
                : ((i = e.sourceFromHex(t)),
                  i || (i = e.sourceFromRgb(t)),
                  i || (i = e.sourceFromHsl(t)),
                  void (i && this.setSource(i)))
            );
          },
        ...
        (r.Color.sourceFromRgb = function(t) {
          ...
          if (i) {
            var r =
                (parseInt(i[1], 10) / (/%$/.test(i[1]) ? 100 : 1)) * (/%$/.test(i[1]) ? 255 : 1),
    ...
    (fabric.Gradient = fabric.util.createClass({
      ...
      toSVG: function(t) {
        ...
        if (
          ...
          for (var n in r)
            'x1' === n || 'x2' === n || 'r2' === n
              ? (r[n] += this.offsetX - t.width / 2)
              : ('y1' === n || 'y2' === n) && (r[n] += this.offsetY - t.height / 2);
        (i = 'id="SVGID_' + this.id + '" gradientUnits="userSpaceOnUse"'),
          this.gradientTransform &&
            (i += ' gradientTransform="matrix(' + this.gradientTransform.join(' ') + ')" '),
          'linear' === this.type
            ? (e = [
                '<linearGradient ',
                i,
        ...
        for (var s = 0; s < this.colorStops.length; s++)
          e.push(
            '<stop ',
            'offset="',
            100 * this.colorStops[s].offset + '%',
            '" style="stop-color:',
            this.colorStops[s].color,
            null != this.colorStops[s].opacity
              ? ';stop-opacity: ' + this.colorStops[s].opacity
              : ';',
            '"/>\n',
          );
        return (
          e.push('linear' === this.type ? '</linearGradient>\n' : '</radialGradient>\n'), e.join('')
        );
      },
      toLive: function(t, e) {
        var i,
          ...
          if (e.group && 'path-group' === e.group.type)
            for (r in n)
              'x1' === r || 'x2' === r
                ...
                : ('y1' === r || 'y2' === r) && (n[r] += -this.offsetY + e.height / 2);
          'linear' === this.type
      ...
      fabric.util.object.extend(fabric.Gradient, {
        fromElement: function(n, s) {
          ...
          return (
            (l || '' !== o) &&
              (g.gradientTransform = fabric.parseTransformAttribute((l || '') + o)),
            g
          );
        },
    ...
    toObject: function() {
      ...
      return (
        'function' == typeof this.source
          ? (t = String(this.source))
          : 'string' == typeof this.source.src
            ? (t = this.source.src)
            : 'object' == typeof this.source &&
              this.source.toDataURL &&
              (t = this.source.toDataURL()),
        { source: t, repeat: this.repeat, offsetX: this.offsetX, offsetY: this.offsetY }
      );
    },
    toSVG: function(t) {
    ...
    (fabric.StaticCanvas = fabric.util.createClass({
      ...
      _initStatic: function(t, e) {
        (this._objects = []),
          ...
          e.backgroundImage &&
            this.setBackgroundImage(e.backgroundImage, this.renderAll.bind(this)),
          e.backgroundColor &&
            this.setBackgroundColor(e.backgroundColor, this.renderAll.bind(this)),
      ...
      _setImageSmoothing: function() {
        ...
        return 'undefined' != typeof t.imageSmoothingEnabled
          ? void (t.imageSmoothingEnabled = this.imageSmoothingEnabled)
          : ((t.webkitImageSmoothingEnabled = this.imageSmoothingEnabled),
            ...
            void (t.oImageSmoothingEnabled = this.imageSmoothingEnabled));
      },
      ...
      _chooseObjectsToRender: function() {
        ...
        if (e && !this.preserveObjectStacking) {
          for (var n = 0, s = this._objects.length; s > n; n++)
            (t = this._objects[n]), e.contains(t) ? r.push(t) : i.push(t);
          e._set('_objects', r);
      ...
      renderAll: function() {
        ...
        return (
          ...
          e.save(),
          (t = this._chooseObjectsToRender()),
          e.transform.apply(e, this.viewportTransform),
          this._renderObjects(e, t),
          this.preserveObjectStacking || this._renderObjects(e, [this.getActiveGroup()]),
          e.restore(),
      ...
      centerObjectH: function(t) {
        return (
          this._centerObject(t, new fabric.Point(this.getCenter().left, t.getCenterPoint().y)),
          this.renderAll(),
          this
        );
      },
      centerObjectV: function(t) {
        return (
          this._centerObject(t, new fabric.Point(t.getCenterPoint().x, this.getCenter().top)),
          this.renderAll(),
          this
        );
      },
      ...
      __serializeBgOverlay: function() {
        ...
        return (
          this.overlayColor &&
            (t.overlay = this.overlayColor.toObject
      ...
      _setSVGBgOverlayColor: function(t, e) {
        this[e] && this[e].source
          ? t.push(
              ...
              '" ',
              'width="',
              'repeat-y' === this[e].repeat || 'no-repeat' === this[e].repeat
                ? this[e].source.width
                : this.width,
              '" height="',
              'repeat-x' === this[e].repeat || 'no-repeat' === this[e].repeat
                ? this[e].source.height
                : this.height,
              '" fill="url(#' + e + 'Pattern)"',
              '></rect>\n',
            )
      ...
      moveTo: function(t, e) {
        return (
          i(this._objects, t), this._objects.splice(e, 0, t), this.renderAll && this.renderAll()
        );
      },
      dispose: function() {
    ...
    fabric.PencilBrush = fabric.util.createClass(fabric.BaseBrush, {
      ...
      _render: function() {
        ...
        t.save(),
          ...
          t.beginPath(),
          2 === this._points.length && i.x === r.x && i.y === r.y && ((i.x -= 0.5), (r.x += 0.5)),
          t.moveTo(i.x, i.y);
  ...
  (fabric.SprayBrush = fabric.util.createClass(fabric.BaseBrush, {
    ...
    _getOptimizedRects: function(t) {
      for (var e, i = {}, r = 0, n = t.length; n > r; r++)
  ...
  (fabric.PatternBrush = fabric.util.createClass(fabric.PencilBrush, {
    ...
    createPath: function(t) {
      ...
      return (
        (e.stroke = new fabric.Pattern({ source: this.source || this.getPatternSrcFunction() })), e
      );
    },
  })),
  (function() {
    ...
    fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, {
      ...
      _normalizePointer: function(t, e) {
        ...
        return (
          o &&
            ((i = fabric.util.transformPoint(r.getCenterPoint(), this.viewportTransform, !0)),
            (n -= i.x),
            (s -= i.y),
            (n /= r.scaleX),
            (s /= r.scaleY)),
      ...
      isTargetTransparent: function(t, e, i) {
        ...
        (t.hasBorders = t.transparentCorners = !1),
          t.render(this.contextCache),
          t._renderControls(this.contextCache),
          (t.hasBorders = r),
      ...
      _shouldClearSelection: function(t, e) {
        ...
        return (
          !e ||
          (e && i && !i.contains(e) && i !== e && !t.shiftKey) ||
          (e && !e.evented) ||
      ...
      _getActionFromCorner: function(t, e, i) {
        ...
        switch (e) {
          ...
          case 'ml':
          case 'mr':
            return i.shiftKey ? 'skewY' : 'scaleX';
          case 'mt':
          case 'mb':
            return i.shiftKey ? 'skewX' : 'scaleY';
          default:
            return 'scale';
        }
      },
      ...
      _skewObject: function(t, e, i) {
        ...
        if (!((s && 'x' === i) || (o && 'y' === i))) {
          var a,
            ...
            f = n._getTransformedDimensions();
          this._changeSkewTransformOrigin(l - u, r, i),
            (a = n.toLocalPoint(new fabric.Point(t, e), r.originX, r.originY)[i]),
            (h = n.translateToOriginPoint(c, r.originX, r.originY)),
            this._setObjectSkew(a, r, i, f),
            (r.lastX = t),
            (r.lastY = e),
      ...
      _setObjectSkew: function(t, e, i, r) {
        ...
        'x' === i
          ...
          2 >= l
            ? (n = 0)
            : ((n = g * Math.atan(l / d['scale' + c] / (o[a] / d['scale' + h]))),
      ...
      _scaleObject: function(t, e, i) {
        ...
        if (!s || !o) {
          ...
          this._setLocalMouse(c, r),
            this._setObjectScale(c, r, s, o, i, a, l),
            n.setPositionByOrigin(h, r.originX, r.originY);
        }
      },
      _setObjectScale: function(t, e, i, r, n, s, o) {
        var a = e.target,
          h = !1,
          c = !1;
        (e.newScaleX = (t.x * a.scaleX) / o.x),
          (e.newScaleY = (t.y * a.scaleY) / o.y),
          s && e.newScaleX <= 0 && e.newScaleX < a.scaleX && (h = !0),
          s && e.newScaleY <= 0 && e.newScaleY < a.scaleY && (c = !0),
          'equally' !== n || i || r
            ? n
              ? 'x' !== n || a.get('lockUniScaling')
                ? 'y' !== n || a.get('lockUniScaling') || c || r || a.set('scaleY', e.newScaleY)
                : h || i || a.set('scaleX', e.newScaleX)
              : (h || i || a.set('scaleX', e.newScaleX), c || r || a.set('scaleY', e.newScaleY))
            : h || c || this._scaleObjectEqually(t, a, e, o),
      ...
      _scaleObjectEqually: function(t, e, i, r) {
        ...
        (i.newScaleX = (i.original.scaleX * n) / s),
          (i.newScaleY = (i.original.scaleY * n) / s),
      ...
      setActiveGroup: function(t, e) {
        return (
          ...
          t && (this.fire('object:selected', { target: t, e: e }), t.fire('selected', { e: e })),
          this
        );
      },
      getActiveGroup: function() {
      ...
      deactivateAllWithDispatch: function(t) {
        ...
        return (
          e && this.fire('before:selection:cleared', { target: e, e: t }),
          this.deactivateAll(),
          e && this.fire('selection:cleared', { e: t }),
          this
        );
      },
  ...
  (function() {
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
      ...
      _shouldRender: function(t, e) {
        ...
        return !!(
          ...
          (e &&
            ...
            this.selection &&
            (e.x !== this._previousPointer.x || e.y !== this._previousPointer.y))
        );
      },
      __onMouseUp: function(t) {
        ...
        this._currentTransform
          ? (this._finalizeCurrentTransform(), (e = this._currentTransform.target))
          : (e = this.findTarget(t, !0));
      ...
      __onMouseDown: function(t) {
        ...
        if (e || fabric.isTouchSupported) {
          ...
          if (!this._currentTransform) {
            ...
            this._shouldClearSelection(t, i)
              ? this._clearSelection(t, i, r)
              : s && (this._handleGrouping(t, i), (i = this.getActiveGroup())),
              i &&
                i.selectable &&
                (i.__corner || !s) &&
                (this._beforeTransform(t, i), this._setupCurrentTransform(t, i)),
              n && this.renderAll(),
      ...
      _beforeTransform: function(t, e) {
        this.stateful && e.saveState(),
          ...
          e !== this.getActiveGroup() &&
            ...
            (this.deactivateAll(), this.setActiveObject(e, t));
      },
      _clearSelection: function(t, e, i) {
        this.deactivateAllWithDispatch(t),
          e && e.selectable
            ? this.setActiveObject(e, t)
            : this.selection && (this._groupSelector = { ex: i.x, ey: i.y, top: 0, left: 0 });
      },
      ...
      _performTransformAction: function(t, e, i) {
        var r = i.x,
          ...
          o = e.action;
        'rotate' === o
          ? (this._rotateObject(r, n), this._fire('rotating', s, t))
          : 'scale' === o
            ? (this._onScale(t, e, r, n), this._fire('scaling', s, t))
            : 'scaleX' === o
              ? (this._scaleObject(r, n, 'x'), this._fire('scaling', s, t))
              : 'scaleY' === o
                ? (this._scaleObject(r, n, 'y'), this._fire('scaling', s, t))
                : 'skewX' === o
                  ? (this._skewObject(r, n, 'x'), this._fire('skewing', s, t))
                  : 'skewY' === o
                    ? (this._skewObject(r, n, 'y'), this._fire('skewing', s, t))
                    : (this._translateObject(r, n),
      ...
      _setCursorFromEvent: function(t, e) {
        ...
        return (
          r ? this._setCornerCursor(r, e, t) : this.setCursor(e.hoverCursor || this.hoverCursor), !0
        );
      },
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
      ...
      _handleGrouping: function(t, e) {
        (e !== this.getActiveGroup() || ((e = this.findTarget(t, !0)), e && !e.isType('group'))) &&
          (this.getActiveGroup() ? this._updateActiveGroup(e, t) : this._createActiveGroup(e, t),
      ...
      _maybeGroupObjects: function(t) {
        ...
        var e = this.getActiveGroup();
        e &&
          (e.setObjectsCoords().setCoords(), (e.isMoving = !1), this.setCursor(this.defaultCursor)),
          (this._groupSelector = null),
          (this._currentTransform = null);
      },
    });
  ...
  fabric.util.object.extend(fabric.StaticCanvas.prototype, {
    ...
    __toDataURL: function(t, e, i) {
      ...
      var s = fabric.StaticCanvas.supports('toDataURLWithQuality')
        ? (n || r).toDataURL('image/' + t, e)
        : (n || r).toDataURL('image/' + t);
      return n && (n = null), s;
    },
    __getCroppedCanvas: function(t, e) {
      var i,
        r,
        n = 'left' in e || 'top' in e || 'width' in e || 'height' in e;
      return (
        n &&
          ((i = fabric.util.createCanvasElement()),
          (r = i.getContext('2d')),
          (i.width = e.width || this.width),
          (i.height = e.height || this.height),
          r.drawImage(t, -e.left || 0, -e.top || 0)),
        i
      );
    },
    __toDataURLWithMultiplier: function(t, e, i, r) {
      ...
      r > 1 && this.setWidth(o).setHeight(a),
        ...
        c
          ? this._tempRemoveBordersControlsFromGroup(c)
          : h && this.deactivateAll && this.deactivateAll();
      var u = this.__toDataURL(t, e, i);
      return (
        (this.width = n),
        (this.height = s),
        l.scale(1 / r, 1 / r),
        this.setWidth(n).setHeight(s),
        c
          ? this._restoreBordersControlsOnGroup(c)
          : h && this.setActiveObject && this.setActiveObject(h),
        this.contextTop && this.clearContext(this.contextTop),
        this.renderAll(),
        u
      );
      ...
      ((e.Object = e.util.createClass({
          ...
          if (this.active && !i) {
            ...
            (o = e.util.multiplyTransformMatrices(n, o)),
              ...
              this.group && this.group === this.canvas.getActiveGroup()
                ? (t.rotate(s(r.angle)), this.drawBordersInGroup(t, r))
                : (t.rotate(s(this.angle)), this.drawBorders(t)),
              this.drawControls(t),
              t.restore();
          }
        },
        _setShadow: function(t) {
          if (this.shadow) {
            ...
            (t.shadowColor = this.shadow.color),
              (t.shadowBlur = (this.shadow.blur * (e + i) * (this.scaleX + this.scaleY)) / 4),
              (t.shadowOffsetX = this.shadow.offsetX * e * this.scaleX),
              (t.shadowOffsetY = this.shadow.offsetY * i * this.scaleY);
          }
        },
          ...
          if (this.stroke && 0 !== this.strokeWidth) {
            if (
              ...
              1 & this.strokeDashArray.length &&
                ...
                o
                  ? (t.setLineDash(this.strokeDashArray), this._stroke && this._stroke(t))
                  : this._renderDashedStroke && this._renderDashedStroke(t),
                t.stroke();
            else {
        ...
        getLocalPointer: function(t, i) {
          ...
          return (
            this.angle && (r = e.util.rotatePoint(r, n, e.util.degreesToRadians(-this.angle))),
            { x: r.x - n.x, y: r.y - n.y }
          );
        },
  ...
  (function() {
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
      translateToGivenOrigin: function(t, r, n, s, o) {
        ...
        return (
          (l || u) &&
            ((a = this._getTransformedDimensions()), (h = t.x + l * a.x), (c = t.y + u * a.y)),
      ...
      adjustPosition: function(i) {
        var r = t(this.angle),
          ...
          s = Math.cos(r) * n,
          o = Math.sin(r) * n;
        (this.left += s * (e[i] - e[this.originX])),
          (this.top += o * (e[i] - e[this.originX])),
          this.setCoords(),
          (this.originX = i);
      },
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        ...
        for (var l in e)
          if (
            ...
            !(
              (h.o.y < t.y && h.d.y < t.y) ||
              (h.o.y >= t.y && h.d.y >= t.y) ||
              (h.o.x === h.d.x && h.o.x >= t.x
                ? ((o = h.o.x), (a = t.y))
                : ((i = 0),
                  (r = (h.d.y - h.o.y) / (h.d.x - h.o.x)),
                  (n = t.y - i * t.x),
                  (s = h.o.y - r * h.o.x),
                  (o = -(n - s) / (i - r)),
                  (a = n + i * o)),
      ...
      getBoundingRect: function() {
        return (
          ...
          fabric.util.makeBoundingBoxFromPoints([
            this.oCoords.tl,
            this.oCoords.tr,
            this.oCoords.br,
            this.oCoords.bl,
      ...
      setCoords: function() {
        ...
        var o = Math.sin(t),
          ...
          x = new fabric.Point(
            m.x + o * this.rotatingPointOffset,
            m.y - a * this.rotatingPointOffset,
          );
        return (
          (this.oCoords = { tl: d, tr: g, br: v, bl: p, ml: b, mt: m, mr: y, mb: _, mtr: x }),
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
      ...
      _getNonTransformedDimensions: function() {
        var t = this.strokeWidth,
          ...
          n = !0;
        return (
          'line' === this.type && 'butt' === this.strokeLineCap && ((n = e), (r = i)),
          n && (i += 0 > i ? -t : t),
          r && (e += 0 > e ? -t : t),
          { x: e, y: i }
        );
      ...
      _getTransformedDimensions: function(t, e) {
        ...
        return (r = fabric.util.makeBoundingBoxFromPoints(a)), { x: r.width, y: r.height };
      },
      _calculateCurrentDimensions: function() {
        ...
        return (
          (i += 2 * this.padding),
          (r += 2 * this.padding),
          fabric.util.transformPoint(new fabric.Point(i, r), t, !0)
        );
      },
      ...
      drawControls: function(t) {
        ...
        return (
          ...
          this.hasRotatingPoint &&
            this._drawControl('mtr', t, a, s + i / 2, o - this.rotatingPointOffset),
          t.restore(),
          this
        );
      },
  ...
  (function(t) {
    ...
    return e.Polygon
      ...
      : ((e.Polygon = e.util.createClass(e.Object, {
          ...
          toSVG: function(t) {
            for (
              var e = [], i = this._createBaseSVGMarkup(), r = 0, n = this.points.length;
              n > r;
              r++
            )
              e.push(s(this.points[r].x, 2), ',', s(this.points[r].y, 2), ' ');
            return (
              i.push(
                '<',
                this.type,
          ...
          commonRender: function(t) {
            ...
            t.beginPath(),
              this._applyPointOffset &&
                ((this.group && 'path-group' === this.group.type) || this._applyPointOffset(),
    ...
    return e.Path
      ...
      : ((e.Path = e.util.createClass(e.Object, {
          ...
          toObject: function(t) {
            ...
            return (
              this.sourcePath && (e.sourcePath = this.sourcePath),
          ...
          toSVG: function(t) {
            for (
              var e = [], i = this._createBaseSVGMarkup(), r = '', n = 0, s = this.path.length;
              s > n;
              n++
            )
            ...
            return (
              (this.group && 'path-group' === this.group.type) ||
                (r = ' translate(' + -this.pathOffset.x + ', ' + -this.pathOffset.y + ') '),
              i.push(
                '<path ',
                'd="',
                o,
          ...
          _parsePath: function() {
            for (
              ...
              var g = n[0],
                ...
                v = h[g] || g;
              if (n.length - 1 > p)
                for (var b = 1, m = n.length; m > b; b += p)
          ...
          _parseDimensions: function() {
            ...
            var m = i(a) || 0,
              ...
              S = _ - m,
              C = x - y,
              w = { left: m, top: y, width: S, height: C };
            return w;
          },
        })),
  ...
  (function(t) {
    ...
    if (!e.Group) {
      ...
      (e.Group = e.util.createClass(e.Object, e.Collection, {
        ...
        initialize: function(t, e, i) {
          ...
          (this.originalState = {}),
            ...
            i
              ...
              : (this._calcBounds(), this._updateObjectsCoords(), this.callSuper('initialize', e)),
            this.setCoords(),
            this.saveCoords();
        },
        ...
        toObject: function(t) {
          return i(this.callSuper('toObject', t), { objects: s(this._objects, 'toObject', t) });
        },
        render: function(t) {
          if (this.visible) {
            t.save(),
        ...
        saveCoords: function() {
          return (
            (this._originalLeft = this.get('left')), (this._originalTop = this.get('top')), this
          );
        },
        hasMoved: function() {
        ...
        _calcBounds: function(t) {
          for (
            ...
            for (e = this._objects[a], e.setCoords(), r = 0; c > r; r++)
      ...
      t.fabric.Image
        ...
        : ((fabric.Image = fabric.util.createClass(fabric.Object, {
            ...
            toObject: function(t) {
              ...
              return (
                this.resizeFilters.length > 0 &&
                  (r.resizeFilters = this.resizeFilters.map(function(t) {
                    return t && t.toObject();
                  })),
                this.includeDefaultValues || this._removeDefaultValues(r),
                r
              );
            },
            toSVG: function(t) {
              ...
              if (
                ...
                'none' !== this.alignX &&
                  'none' !== this.alignY &&
                  (n = 'x' + this.alignX + 'Y' + this.alignY + ' ' + this.meetOrSlice),
                e.push(
                  '<g transform="',
                  this.getSvgTransform(),
                  this.getSvgTransformMatrix(),
            ...
            applyFilters: function(t, e, i, r) {
              if (((e = e || this.filters), (i = i || this._originalElement))) {
                ...
                return (
                  ...
                  0 === e.length
                    ? ((this._element = i), t && t(), s)
                    : (e.forEach(function(t) {
                        t && t.applyTo(s, t.scaleX || a.scaleX, t.scaleY || a.scaleY),
                          !r &&
                            t &&
                            'Resize' === t.type &&
                            ((a.width *= t.scaleX), (a.height *= t.scaleY));
                      }),
                      (o.width = s.width),
                      (o.height = s.height),
                      fabric.isLikelyNode
                        ? ((o.src = s.toBuffer(void 0, fabric.Image.pngCompression)),
                          (a._element = o),
                          !r && (a._filteredEl = o),
                          t && t())
                        : ((o.onload = function() {
            ...
            _initElement: function(t, e) {
              this.setElement(fabric.util.getById(t), null, e),
            ...
            _setWidthHeight: function(t) {
              (this.width =
                'width' in t ? t.width : this.getElement() ? this.getElement().width || 0 : 0),
                (this.height =
                  'height' in t ? t.height : this.getElement() ? this.getElement().height || 0 : 0);
            },
            complexity: function() {
              return 1;
            },
          ...
          (fabric.Image.fromElement = function(t, i, r) {
            ...
            s.preserveAspectRatio &&
              ((n = fabric.util.parsePreserveAspectRatioAttribute(s.preserveAspectRatio)), e(s, n)),
    ...
    (e.Image.filters.Noise = e.util.createClass(e.Image.filters.BaseFilter, {
      ...
      applyTo: function(t) {
        for (
          ...
          (e = (0.5 - Math.random()) * s), (n[o] += e), (n[o + 1] += e), (n[o + 2] += e);
        i.putImageData(r, 0, 0);
      },
      toObject: function() {
        ...
        for (i = 0; u > i; i += this.blocksize)
          for (r = 0; f > r; r += this.blocksize) {
            ...
            for (var d = i, g = i + this.blocksize; g > d; d++)
              for (var p = r, v = r + this.blocksize; v > p; p++)
    ...
    (e.Image.filters.Tint = e.util.createClass(e.Image.filters.BaseFilter, {
      ...
      initialize: function(t) {
        (t = t || {}),
          ...
          (this.opacity =
            'undefined' != typeof t.opacity ? t.opacity : new e.Color(this.color).getAlpha());
      },
      applyTo: function(t) {
        var i,
          r,
    ...
    (e.Image.filters.Multiply = e.util.createClass(e.Image.filters.BaseFilter, {
      ...
      applyTo: function(t) {
        var i,
          ...
          o = s.data,
          a = o.length;
        for (r = new e.Color(this.color).getSource(), i = 0; a > i; i += 4)
          (o[i] *= r[0] / 255), (o[i + 1] *= r[1] / 255), (o[i + 2] *= r[2] / 255);
        n.putImageData(s, 0, 0);
      },
      toObject: function() {
      ...
      applyTo: function(t) {
        ...
        if (this.image) {
          ...
          (u = new e.Color(this.color).getSource()),
            ...
            (r = u[1] * this.alpha),
            (n = u[2] * this.alpha);
        for (var y = 0, _ = g.length; _ > y; y += 4)
          switch (
            ((s = g[y]),
            (o = g[y + 1]),
            (a = g[y + 2]),
            p &&
              ((i = u[y] * this.alpha), (r = u[y + 1] * this.alpha), (n = u[y + 2] * this.alpha)),
            this.mode)
          ) {
            case 'multiply':
    ...
    (e.Image.filters.Resize = e.util.createClass(e.Image.filters.BaseFilter, {
      ...
      lanczosResize: function(t, e, o, a, l) {
        ...
        function f(t) {
          ...
          for (T.x = (t + 0.5) * y, k.x = r(T.x), h = 0; l > h; h++) {
            for (
              T.y = (h + 0.5) * _, k.y = r(T.y), g = 0, j = 0, A = 0, M = 0, P = 0, c = k.x - C;
              c <= k.x + C;
              c++
            )
              if (!(0 > c || c >= e)) {
                (L = r(1e3 * s(c - T.x))), O[L] || (O[L] = {});
                for (var I = k.y - w; I <= k.y + w; I++)
                  0 > I ||
                    I >= o ||
                    ((D = r(1e3 * s(I - T.y))),
                    O[L][D] || (O[L][D] = m(n(i(L * x, 2) + i(D * S, 2)) / 1e3)),
                    (u = O[L][D]),
                    u > 0 &&
                      ((d = 4 * (I * e + c)),
                      (g += u),
      ...
      bilinearFiltering: function(t, e, i, n, s) {
        ...
        for (f = 0; s > f; f++)
          for (d = 0; n > d; d++)
            for (
              l = r(_ * d), u = r(x * f), g = _ * d - l, p = x * f - u, m = 4 * (u * e + l), v = 0;
              4 > v;
              v++
            )
              (o = O[m + v]),
        ...
        for (
          ...
          for (var y = 0; o > y; y++) {
            for (
              ...
              for (
                var M = s(j - (A + 0.5)) / f, P = (y + 0.5) * h, L = M * M, D = r(y * h);
                (y + 1) * h > D;
                D++
              ) {
                var I = s(P - (D + 0.5)) / u,
    ...
    a.push(
      ...
      (e.Text = e.util.createClass(e.Object, {
        ...
        _initDimensions: function(t) {
          this.__skipDimension ||
            ...
            this._clearCache(),
            (this._cacheLinesWidth = 'justify' !== this.textAlign),
            (this.width = this._getTextWidth(t)),
            (this._cacheLinesWidth = !0),
        ...
        _renderTextLine: function(t, e, i, r, n, s) {
          ...
          for (
            var a,
              h = i.split(/\s+/),
              c = 0,
              l = this._getWidthOfWords(e, i, s, 0),
              u = this.width - l,
              f = h.length - 1,
              d = f > 0 ? u / f : 0,
              g = 0,
          ...
          if ((this.stroke && 0 !== this.strokeWidth) || this._skipFillStrokeCheck) {
            ...
            this.shadow && !this.shadow.affectStroke && this._removeShadow(t),
              ...
              this.strokeDashArray &&
                (1 & this.strokeDashArray.length &&
                  this.strokeDashArray.push.apply(this.strokeDashArray, this.strokeDashArray),
                s && t.setLineDash(this.strokeDashArray)),
              t.beginPath();
        ...
        _renderTextBoxBackground: function(t) {
          this.backgroundColor &&
            ...
            t.fillRect(this._getLeftOffset(), this._getTopOffset(), this.width, this.height));
        },
        _renderTextLinesBackground: function(t) {
          if (this.textBackgroundColor) {
            ...
            for (var s = 0, o = this._textLines.length; o > s; s++)
              '' !== this._textLines[s] &&
                ((e = 'justify' === this.textAlign ? this.width : this._getLineWidth(t, s)),
                (i = this._getLineLeftOffset(e)),
                t.fillRect(
                  this._getLeftOffset() + i,
        ...
        _getLineWidth: function(t, e) {
          ...
          return (
            '' === n
              ? (i = 0)
              : 'justify' === this.textAlign && this._cacheLinesWidth
                ? ((r = n.split(/\s+/)), (i = r.length > 1 ? this.width : t.measureText(n).width))
                : (i = t.measureText(n).width),
            this._cacheLinesWidth && (this.__lineWidths[e] = i),
            i
          );
        },
        ...
        _setSVGTextLineText: function(t, i, r, s, a) {
          var h =
            this.fontSize * (this._fontSizeMult - this._fontSizeFraction) - a + r - this.height / 2;
          return 'justify' === this.textAlign
            ? void this._setSVGTextLineJustifed(t, i, h, s)
            : void i.push(
                '      <tspan x="',
                n(s + this._getLineLeftOffset(this._getLineWidth(this.ctx, t)), o),
                '" ',
                'y="',
                n(h, o),
                '" ',
        ...
        _setSVGTextLineBg: function(t, e, i, r, s) {
          t.push(
            ...
            ' x="',
            n(i + this._getLineLeftOffset(this._getLineWidth(this.ctx, e)), o),
            '" y="',
            n(s - this.height / 2, o),
            '" width="',
            n(this._getLineWidth(this.ctx, e), o),
            '" height="',
            n(this._getHeightOfLine(this.ctx, e) / this.lineHeight, o),
            '"></rect>\n',
          );
        },
        ...
        _getFillAttributes: function(t) {
          ...
          return i && i.getSource() && 1 !== i.getAlpha()
            ? 'opacity="' + i.getAlpha() + '" fill="' + i.setAlpha(1).toRgb() + '"'
            : 'fill="' + t + '"';
        },
        _set: function(t, e) {
          this.callSuper('_set', t, e),
      ...
      (e.Text.fromElement = function(t, i) {
        ...
        var s = new e.Text(n, i),
          o = 0;
        return (
          'left' === s.originX && (o = s.getWidth() / 2),
          'right' === s.originX && (o = -s.getWidth() / 2),
          s.set({
            left: s.getLeft() + o,
            top: s.getTop() - s.getHeight() / 2 + s.fontSize * (0.18 + s._fontSizeFraction),
          }),
          s
        );
      }),
    ...
    (fabric.IText = fabric.util.createClass(fabric.Text, fabric.Observable, {
        ...
        if (this.active) {
          ...
          this.canvas.contextTop
            ...
            this.selectionStart === this.selectionEnd
              ? ((t = this._getCursorBoundaries(i, 'cursor')), this.renderCursor(t, e))
              : ((t = this._getCursorBoundaries(i, 'selection')), this.renderSelection(i, t, e)),
            e.restore();
        }
      },
      ...
      _getCursorBoundariesOffsets: function(t, e) {
        for (var i = 0, r = 0, n = 0, s = 0, o = 0, a = 0; a < this.selectionStart; a++)
          '\n' === t[a]
            ? ((o = 0), (s += this._getHeightOfLine(this.ctx, r)), r++, (n = 0))
            : ((o += this._getWidthOfChar(this.ctx, t[a], r, n)), n++),
            (i = this._getLineLeftOffset(this._getLineWidth(this.ctx, r)));
        return (
          'cursor' === e &&
            (s +=
              ((1 - this._fontSizeFraction) * this._getHeightOfLine(this.ctx, r)) /
                this.lineHeight -
              this.getCurrentCharFontSize(r, n) * (1 - this._fontSizeFraction)),
          { top: s, left: o, lineLeft: i }
        );
      },
      ...
      renderSelection: function(t, e, i) {
        ...
        for (
          ...
          var h = this._getLineLeftOffset(this._getLineWidth(i, a)) || 0,
            ...
            u = this._textLines[a];
          if (a === s)
            for (var f = 0, d = u.length; d > f; f++)
              f >= r.charIndex &&
                (a !== o || f < n.charIndex) &&
                (l += this._getWidthOfChar(i, u[f], a, f)),
                f < r.charIndex && (h += this._getWidthOfChar(i, u[f], a, f));
      ...
      _renderChars: function(t, e, i, r, n, s, o) {
        ...
        for (var f = o, d = i.length + o; d >= f; f++)
          (a = a || this.getCurrentCharStyle(s, f)),
            (h = this.getCurrentCharStyle(s, f + 1)),
            (this._hasStyleChanged(a, h) || f === d) &&
              (this._renderChar(t, e, s, f - 1, u, r, n, c), (u = ''), (a = h)),
            (u += i[f - o]);
        e.restore();
      },
      ...
      _renderChar: function(t, e, i, r, n, s, o, a) {
        var h,
          ...
          f,
          d,
          g = this._getStyleDeclaration(i, r);
        g
          ...
          g && e.save(),
          (h = this._applyCharStylesGetWidth(e, n, i, r, g || {})),
      ...
      _renderTextLine: function(t, e, i, r, n, s) {
        this.isEmptyStyles() || (n += this.fontSize * (this._fontSizeFraction + 0.03)),
              ...
              if (
                (this.textBackgroundColor &&
                  ...
                  t.fillRect(
                    ...
                    this._getTopOffset() + e,
                    s,
                    n / this.lineHeight,
                  )),
                this._getLineStyle(i))
              )
                for (var a = 0, h = this._textLines[i].length; h > a; a++) {
                  ...
                  if (c && c.textBackgroundColor) {
                    ...
                    (t.fillStyle = c.textBackgroundColor),
                      t.fillRect(
                        this._getLeftOffset() + o + this._getWidthOfCharsAt(t, i, a),
                        this._getTopOffset() + e,
                        this._getWidthOfChar(t, l, i, a) + 1,
                        n / this.lineHeight,
                      );
                  }
                }
      ...
      _applyCharStylesGetWidth: function(e, i, r, n, s) {
        var o,
          a = this._getStyleDeclaration(r, n),
          h = s || t(a);
        ...
        return (
          (e.fillStyle = l.toLive ? l.toLive(e, this) : l),
          h.stroke &&
            (e.strokeStyle = h.stroke && h.stroke.toLive ? h.stroke.toLive(e, this) : h.stroke),
          (e.lineWidth = h.strokeWidth || this.strokeWidth),
          (e.font = this._getFontDeclaration.call(h)),
          this._setShadow.call(h, e),
          (this.caching && this._charWidthsCache[c]) ||
            ((o = e.measureText(i).width), this.caching && (this._charWidthsCache[c] = o)),
          this._charWidthsCache[c]
        );
      },
      ...
      _getWidthOfChar: function(t, e, i, r) {
        if ('justify' === this.textAlign && this._reSpacesAndTabs.test(e))
      ...
      _getLineWidth: function(t, e) {
        return this.__lineWidths[e]
          ? this.__lineWidths[e]
          : ((this.__lineWidths[e] = this._getWidthOfCharsAt(t, e, this._textLines[e].length)),
            this.__lineWidths[e]);
      },
      ...
      _getHeightOfLine: function(t, e) {
        ...
        for (
          var i = this._textLines[e], r = this._getHeightOfChar(t, e, 0), n = 1, s = i.length;
          s > n;
          n++
        ) {
        ...
        return (
          (this.__lineHeights[e] = r * this.lineHeight * this._fontSizeMult), this.__lineHeights[e]
        );
      },
      _getTextHeight: function(t) {
        for (var e = 0, i = 0, r = this._textLines.length; r > i; i++)
          e += this._getHeightOfLine(t, i);
        return e;
      },
      _renderTextBoxBackground: function(t) {
        this.backgroundColor &&
      ...
      toObject: function(e) {
        ...
        return fabric.util.object.extend(this.callSuper('toObject', e), { styles: s });
      },
    })),
    ...
    fabric.util.object.extend(fabric.IText.prototype, {
      ...
      initAddedHandler: function() {
        ...
        this.on('added', function() {
          this.canvas &&
            ...
            t.canvas &&
              ((t.canvas._iTextInstances = t.canvas._iTextInstances || []),
      ...
      initRemovedHandler: function() {
        ...
        this.on('removed', function() {
          t.canvas &&
            ((t.canvas._iTextInstances = t.canvas._iTextInstances || []),
            fabric.util.removeFromArray(t.canvas._iTextInstances, t));
        });
      },
      _initCanvasHandlers: function() {
        ...
        this.canvas.on('selection:cleared', function() {
          ...
          this.canvas.on('mouse:up', function() {
            t.canvas._iTextInstances &&
              t.canvas._iTextInstances.forEach(function(t) {
                t.__isMousedown = !1;
              });
          }),
      ...
      _animateCursor: function(t, e, i, r) {
        ...
        return (
          ...
          t.animate('_currentCursorOpacity', e, {
            ...
            onChange: function() {
              t.canvas &&
                (t.canvas.clearContext(t.canvas.contextTop || t.ctx), t.renderCursorOrSelection());
            },
            abort: function() {
              return n.isAborted;
            },
      ...
      initMouseMoveHandler: function() {
        ...
        this.canvas.on('mouse:move', function(e) {
          if (t.__isMousedown && t.isEditing) {
            ...
            i >= t.__selectionStartOnMouseDown
              ? (t.setSelectionStart(t.__selectionStartOnMouseDown), t.setSelectionEnd(i))
              : (t.setSelectionStart(i), t.setSelectionEnd(t.__selectionStartOnMouseDown));
          }
        });
      },
      ...
      insertChars: function(t, e) {
        ...
        for (var r = 0, n = t.length; n > r; r++)
          e && (i = fabric.copiedTextStyle[r]), this.insertChar(t[r], n - 1 > r, i);
      },
      insertChar: function(t, e, i) {
        var r = '\n' === this.text[this.selectionStart];
        (this.text =
          this.text.slice(0, this.selectionStart) + t + this.text.slice(this.selectionEnd)),
          (this._textLines = this._splitTextIntoLines()),
      ...
      insertNewlineStyleObject: function(e, i, r) {
        ...
        if ((this.styles[e] && this.styles[e][i - 1] && (n = this.styles[e][i - 1]), r))
          ...
          for (var o in this.styles[e])
            parseInt(o, 10) >= i &&
              ((s[parseInt(o, 10) - i] = this.styles[e][o]), delete this.styles[e][o]);
          this.styles[e + 1] = s;
        }
  ...
  fabric.util.object.extend(fabric.IText.prototype, {
    ...
    onMouseDown: function(t) {
      ...
      this.isTripleClick(e)
        ...
        : this.isDoubleClick(e) && (this.fire('dblclick', t), this._stopEvent(t.e)),
    ...
    setCursorByClick: function(t) {
      ...
      t.shiftKey
        ...
        : (this.setSelectionStart(e), this.setSelectionEnd(e));
    },
  ...
  fabric.util.object.extend(fabric.IText.prototype, {
    initHiddenTextarea: function() {
      (this.hiddenTextarea = fabric.document.createElement('textarea')),
        ...
        (this.hiddenTextarea.style.cssText =
          'position: fixed; bottom: 20px; left: 0px; opacity: 0; width: 0px; height: 0px; z-index: -999;'),
    ...
    getDownCursorOffset: function(t, e) {
      var i,
        r,
        n = e ? this.selectionEnd : this.selectionStart,
      ...
      if (o === this._textLines.length - 1 || t.metaKey || 34 === t.keyCode)
        return this.text.length - n;
      var l = this._getLineWidth(this.ctx, o);
      r = this._getLineLeftOffset(l);
      for (var u = r, f = 0, d = a.length; d > f; f++)
        (i = a[f]), (u += this._getWidthOfChar(this.ctx, i, o, f));
    ...
    _getIndexOnNextLine: function(t, e, i) {
      for (
        var r,
          n = t.lineIndex + 1,
          s = this._getLineWidth(this.ctx, n),
          o = this._getLineLeftOffset(s),
          a = o,
          h = 0,
          c = 0,
    ...
    moveCursorDownWithoutShift: function(t) {
      (this._selectionDirection = 'right'),
        this.setSelectionStart(this.selectionStart + t),
        this.setSelectionEnd(this.selectionStart);
    },
    ...
    moveCursorDownWithShift: function(t) {
      this.selectionEnd === this.selectionStart && (this._selectionDirection = 'right'),
        'right' === this._selectionDirection
          ? this.setSelectionEnd(this.selectionEnd + t)
          : this.setSelectionStart(this.selectionStart + t),
        this.selectionEnd < this.selectionStart &&
          'left' === this._selectionDirection &&
          (this.swapSelectionPoints(), (this._selectionDirection = 'right')),
    ...
    getUpCursorOffset: function(t, e) {
      ...
      for (
        var s,
          o = this._textLines[n].slice(0, r.charIndex),
          a = this._textLines[n - 1] || '',
          h = this._getLineWidth(this.ctx, r.lineIndex),
        ...
        (s = o[u]), (l += this._getWidthOfChar(this.ctx, s, n, u));
    ...
    moveCursorUp: function(t) {
      ...
      t.shiftKey ? this.moveCursorUpWithShift(e) : this.moveCursorUpWithoutShift(e),
        this.initDelayedCursor();
    },
    moveCursorUpWithShift: function(t) {
      this.selectionEnd === this.selectionStart && (this._selectionDirection = 'left'),
        ...
        this.selectionEnd < this.selectionStart &&
          'right' === this._selectionDirection &&
          (this.swapSelectionPoints(), (this._selectionDirection = 'left'));
    },
    ...
    moveCursorLeft: function(t) {
      (0 !== this.selectionStart || 0 !== this.selectionEnd) &&
        (this.abortCursorAnimation(),
        (this._currentCursorOpacity = 1),
        t.shiftKey ? this.moveCursorLeftWithShift(t) : this.moveCursorLeftWithoutShift(t),
        this.initDelayedCursor());
    },
    _move: function(t, e, i) {
      var r = 'selectionStart' === e ? 'setSelectionStart' : 'setSelectionEnd';
      t.altKey
        ? this[r](this['findWordBoundary' + i](this[e]))
        : t.metaKey || 35 === t.keyCode || 36 === t.keyCode
          ? this[r](this['findLineBoundary' + i](this[e]))
          : this[r](this[e] + ('Left' === i ? -1 : 1));
    },
    ...
    moveCursorRight: function(t) {
      (this.selectionStart >= this.text.length && this.selectionEnd >= this.text.length) ||
        (this.abortCursorAnimation(),
        (this._currentCursorOpacity = 1),
        t.shiftKey ? this.moveCursorRightWithShift(t) : this.moveCursorRightWithoutShift(t),
        this.initDelayedCursor());
    },
    ...
    moveCursorRightWithoutShift: function(t) {
      (this._selectionDirection = 'right'),
        this.selectionStart === this.selectionEnd
          ? (this._moveRight(t, 'selectionStart'), this.setSelectionEnd(this.selectionStart))
    ...
    fabric.util.object.extend(fabric.IText.prototype, {
      ...
      _setSVGTextLineChars: function(t, e, i, r, n) {
        for (
          var s = this._textLines[t],
            o = 0,
            a = this._getLineLeftOffset(this._getLineWidth(this.ctx, t)) - this.width / 2,
      ...
      _createTextCharSpan: function(i, r, n, s, o) {
        ...
        return [
          ...
          t(s - this.height / 2, e),
          '" ',
          r.fontFamily ? 'font-family="' + r.fontFamily.replace(/"/g, "'") + '" ' : '',
    ...
    (e.Textbox = e.util.createClass(e.IText, e.Observable, {
      ...
      initialize: function(t, i) {
        (this.ctx = e.util.createCanvasElement().getContext('2d')),
          ...
          this.set({ lockUniScaling: !1, lockScalingY: !0, lockScalingFlip: !0, hasBorders: !0 }),
      ...
      _generateStyleMap: function() {
        for (var t = 0, e = 0, i = 0, r = {}, n = 0; n < this._textLines.length; n++)
          '\n' === this.text[i] ? ((e = 0), i++, t++) : ' ' === this.text[i] && (e++, i++),
            (r[n] = { line: t, offset: e }),
      ...
      setOnGroup: function(t, e) {
        'scaleX' === t &&
          ...
          this.set(
            'width',
            (this.get('width') * e) /
              ('undefined' == typeof this.__oldScaleX ? 1 : this.__oldScaleX),
          ),
          (this.__oldScaleX = e));
      },
      get2DCursorLocation: function(t) {
        ...
        for (var e = this._textLines.length, i = 0, r = 0; e > r; r++) {
          var n = this._textLines[r],
            s = n.length;
          if (i + s >= t) return { lineIndex: r, charIndex: t - i };
      ...
      _getCursorBoundariesOffsets: function(t, e) {
        for (
          var i = 0,
            ...
            o = this._getLineLeftOffset(this._getLineWidth(this.ctx, n.lineIndex)),
            a = 0;
          a < n.charIndex;
          a++
        )
        ...
        return (
          'cursor' === e &&
            (i +=
              ((1 - this._fontSizeFraction) * this._getHeightOfLine(this.ctx, n.lineIndex)) /
                this.lineHeight -
              this.getCurrentCharFontSize(n.lineIndex, n.charIndex) * (1 - this._fontSizeFraction)),
      ...
      toObject: function(t) {
        return e.util.object.extend(this.callSuper('toObject', t), { minWidth: this.minWidth });
      },
    })),
    ...
    fabric.util.object.extend(fabric.Textbox.prototype, {
      ...
      _getTextOnPreviousLine: function(t) {
        for (
          ...
          this._styleMap[t - 2] && this._styleMap[t - 2].line === this._styleMap[t - 1].line;
  ...
  (function() {
    ...
    fabric.IText.prototype._getNewSelectionStartFromOffset = function(e, i, r, n, s) {
      ...
      for (
        var o = 0, a = 0, h = 0;
        h < this._textLines.length && ((o += this._textLines[h].length), !(o + a >= n));
        h++
      )
  ...
  (function() {
    function request(t, e, i) {
      ...
      var n = 0 === r.protocol.indexOf('https:') ? HTTPS : HTTP,
        s = n.request({ hostname: r.hostname, port: r.port, path: r.path, method: 'GET' }, function(
          t,
        ) {
          var r = '';
          e && t.setEncoding(e),
      ...
      s.on('error', function(t) {
        t.errno === process.ECONNREFUSED
          ? fabric.log('ECONNREFUSED: connection refused to ' + r.hostname + ':' + r.port)
    ...
    if ('undefined' == typeof document || 'undefined' == typeof window) {
      ...
      (fabric.util.loadImage = function(t, e, i) {
        function r(r) {
          r
            ? ((n.src = new Buffer(r, 'binary')), (n._src = t), e && e.call(i, n))
        ...
        (fabric.Image.fromObject = function(t, e) {
          fabric.util.loadImage(t.src, function(i) {
            ...
            r._initConfig(t),
              r._initFilters(t.filters, function(i) {
                (r.filters = i || []),
                  r._initFilters(t.resizeFilters, function(t) {
        ...
        (fabric.createCanvasForNode = function(t, e, i, r) {
          ...
          var o = fabric.Canvas || fabric.StaticCanvas,
            a = new o(n, i);
          return (
            (a.contextContainer = s.getContext('2d')), (a.nodeCanvas = s), (a.Font = Canvas.Font), a
          );
        }),
