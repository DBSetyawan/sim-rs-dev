...
! function (t) {
    ...
    var l, d, a, p, t, h, g, m, s, e, b, o, i, c, f, v, n, r, y, x, C, w = "ui-effects-",
        k = "ui-effects-style",
    ...
    function B(r) {
        ...
        return r = r.toLowerCase(), b(t, function (t, e) {
            var n = e.re.exec(r),
                n = n && e.parse(n),
                e = e.space || "rgba";
            if (n) return n = i[e](n), i[g[e].cache] = n[g[e].cache], o = i._rgba = n._rgba, !1
        }), o.length ? ("0,0,0,0" === o.join() && l.extend(o, a.transparent), i) : a[r]
    }
    ...
    function I(t) {
        ...
        if (r && r.length && r[0] && r[r[0]])
            for (n = r.length; n--;) "string" == typeof r[e = r[n]] && (i[u.camelCase(e)] = r[e]);
        else
            for (e in r) "string" == typeof r[e] && (i[e] = r[e]);
        return i
    }
    ...
    function T(t, e, n, r) {
        ...
        }, u.isFunction(e = null == e ? {} : e) && (r = e, n = null, e = {}), "number" != typeof e && !u.fx.speeds[e] || (r = n, n = e, e = {}), u.isFunction(n) && (r = n, n = null), e && u.extend(t, e), n = n || e.duration, t.duration = u.fx.off ? 0 : "number" == typeof n ? n : n in u.fx.speeds ? u.fx.speeds[n] : u.fx.speeds._default, t.complete = r || e.complete, t
    }
    ...
    return u.effects = {
        ...
        p = /^([\-+])=\s*(\d+\.?\d*)/, t = [{
        ...
        }, s = h.support = {}, e = l("<p>")[0], b = l.each, e.style.cssText = "background-color:rgba(1,1,1,.5)", s.rgba = -1 < e.style.backgroundColor.indexOf("rgba"), b(g, function (t, e) {
            ...
            parse: function (i, t, e, n) {
                ...
                var o = this,
                    r = l.type(i),
                    s = this._rgba = [];
                return t !== d && (i = [i, t, e, n], r = "array"), "string" === r ? this.parse(B(i) || a._default) : "array" === r ? (b(g.rgba.props, function (t, e) {
                    s[e.idx] = M(i[e.idx], e)
                }), this) : "object" === r ? (b(g, i instanceof h ? function (t, e) {
                    ...
                    b(n.props, function (t, e) {
                        ...
                        o[r][e.idx] = M(i[t], e, !0)
                    }), o[r] && l.inArray(null, o[r].slice(0, 3)) < 0 && (o[r][3] = 1, n.from && (o._rgba = n.from(o[r])))
                }), this) : void 0
            },
            is: function (t) {
                var i = h(t),
                ...
                return b(g, function (t, e) {
                    var n, r = i[e.cache];
                    return r && (n = s[e.cache] || e.to && e.to(s._rgba) || [], b(e.props, function (t, e) {
            ...
            transition: function (t, s) {
                ...
                return b(n.props, function (t, e) {
                    var n = e.idx,
                        ...
                        i = f[n],
                        o = m[e.type] || {};
                    null !== i && (null === r ? c[n] = i : (o.mod && (i - r > o.mod / 2 ? r += o.mod : r - i > o.mod / 2 && (r -= o.mod)), c[n] = M((i - r) * s + r, e)))
                }), this[e](c)
            },
            blend: function (t) {
            ...
            toHexString: function (t) {
                var e = this._rgba.slice(),
                    n = e.pop();
                return t && e.push(~~(255 * n)), "#" + l.map(e, function (t) {
        ...
        })).parse.prototype = h.fn, g.hsla.to = function (t) {
            ...
            var e = t[0] / 255,
                ...
                c = o + s,
                t = .5 * c,
                n = s === o ? 0 : e === o ? 60 * (n - r) / a + 360 : n === o ? 60 * (r - e) / a + 120 : 60 * (e - n) / a + 240,
            ...
            var e = t[0] / 360,
                ...
                n = r <= .5 ? r * (1 + n) : r + n - r * n,
                r = 2 * r - n;
            return [Math.round(255 * H(r, n, e + 1 / 3)), Math.round(255 * H(r, n, e)), Math.round(255 * H(r, n, e - 1 / 3)), t]
        }, b(g, function (c, t) {
            var o = t.props,
                s = t.cache,
                a = t.to,
                f = t.from;
            h.fn[c] = function (t) {
                if (a && !this[s] && (this[s] = a(this._rgba)), t === d) return this[s].slice();
                var e, n = l.type(t),
                ...
                h.fn[s] || (h.fn[s] = function (t) {
                    var e, n = l.type(t),
                        ...
                        i = this[r](),
                        o = i[a.idx];
                    return "undefined" === n ? o : ("function" === n && (t = t.call(this, o), n = l.type(t)), null == t && a.empty ? this : ("string" === n && (e = p.exec(t)) && (t = o + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)), i[a.idx] = t, this[r](i)))
                })
            })
        }), (h.hook = function (t) {
            t = t.split(" ");
            b(t, function (t, o) {
                l.cssHooks[o] = {
                    set: function (t, e) {
                        ...
                        if ("transparent" !== e && ("string" !== l.type(e) || (n = B(e)))) {
                            if (e = h(n || e), !s.rgba && 1 !== e._rgba[3]) {
                                for (r = "backgroundColor" === o ? t.parentNode : t;
                                    ("" === i || "transparent" === i) && r && r.style;) try {
                    ...
                    t.colorInit || (t.start = h(t.elem, o), t.end = h(t.end), t.colorInit = !0), l.cssHooks[o].set(t.elem, t.start.transition(t.end, t.pos))
                }
            })
            ...
            return this.queue(function () {
                ...
                r(), e = e.map(function () {
                    return this.end = I(this.el[0]), this.diff = function (t, e) {
                        var n, r, i = {};
                        for (n in e) r = e[n], t[n] !== r && (v[n] || !u.fx.step[n] && isNaN(parseFloat(r)) || (i[n] = r));
                        return i
            ...
            addClass: (c = u.fn.addClass, function (t, e, n, r) {
                return e ? u.effects.animateClass.call(this, {
                    add: t
                }, e, n, r) : c.apply(this, arguments)
            }),
            removeClass: (i = u.fn.removeClass, function (t, e, n, r) {
                return 1 < arguments.length ? u.effects.animateClass.call(this, {
                    remove: t
                }, e, n, r) : i.apply(this, arguments)
            }),
            toggleClass: (o = u.fn.toggleClass, function (t, e, n, r, i) {
                return "boolean" == typeof e || void 0 === e ? n ? u.effects.animateClass.call(this, e ? {
                    add: t
                } : {
                    remove: t
                }, n, r, i) : o.apply(this, arguments) : u.effects.animateClass.call(this, {
                    toggle: t
                }, e, n, r)
            }),
        ...
        }), u.expr && u.expr.filters && u.expr.filters.animated && (u.expr.filters.animated = (n = u.expr.filters.animated, function (t) {
            return !!u(t).data(_) || n(t)
        })), !1 !== u.uiBackCompat && u.extend(u.effects, {
            save: function (t, e) {
                for (var n = 0, r = e.length; n < r; n++) null !== e[n] && t.data(w + e[n], t[0].style[e[n]])
            },
            restore: function (t, e) {
                for (var n, r = 0, i = e.length; r < i; r++) null !== e[r] && (n = t.data(w + e[r]), t.css(e[r], n))
            },
            ...
            createWrapper: function (n) {
                ...
                return n.wrap(t), n[0] !== i && !u.contains(n[0], i) || u(i).trigger("focus"), t = n.parent(), "static" === n.css("position") ? (t.css({
                    position: "relative"
                }), n.css({
                    position: "relative"
                })) : (u.extend(r, {
            ...
            setTransition: function (r, t, i, o) {
                return o = o || {}, u.each(t, function (t, e) {
                    var n = r.cssUnit(e);
                    0 < n[0] && (o[e] = n[0] * i + n[1])
                }), o
            }
            ...
            effect: function () {
                function t(t) {
                    ...
                    e.data(_, !0), c.push(n), o && ("show" === n || n === o && "hide" === n) && e.show(), o && "none" === n || u.effects.saveStyle(e), u.isFunction(t) && t()
                }
                var r = T.apply(this, arguments),
                    ...
                    a = r.mode,
                    c = [];
                return u.fx.off || !i ? a ? this[a](r.duration, s) : this.each(function () {
                    s && s.call(this)
                ...
                function f(t) {
                    ...
                    r.mode = c.shift(), !1 === u.uiBackCompat || o ? "none" === r.mode ? (e[a](), n()) : i.call(e[0], r, function () {
                        e.removeData(_), u.effects.cleanUp(e), "hide" === r.mode && e.hide(), n()
                    }) : (e.is(":hidden") ? "hide" === a : "show" === a) ? (e[a](), n()) : i.call(e[0], r, n)
                }
            },
            show: (x = u.fn.show, function (t) {
                if (F(t)) return x.apply(this, arguments);
                var e = T.apply(this, arguments);
                return e.mode = "show", this.effect.call(this, e)
            }),
            hide: (y = u.fn.hide, function (t) {
                if (F(t)) return y.apply(this, arguments);
                var e = T.apply(this, arguments);
                return e.mode = "hide", this.effect.call(this, e)
            }),
            toggle: (r = u.fn.toggle, function (t) {
            ...
            cssClip: function (t) {
                return t ? this.css("clip", "rect(" + t.top + "px " + t.right + "px " + t.bottom + "px " + t.left + "px)") : W(this.css("clip"), this)
            },
            transfer: function (t, e) {
                var n = u(this),
                    ...
                    r = n.offset(),
                    c = u("<div class='ui-effects-transfer'></div>").appendTo("body").addClass(t.className).css({
                        top: r.top - s,
                        left: r.left - a,
            ...
            t.clipInit || (t.start = u(t.elem).cssClip(), "string" == typeof t.end && (t.end = W(t.end, t.elem)), t.clipInit = !0), u(t.elem).cssClip({
                top: t.pos * (t.end.top - t.start.top) + t.start.top,
                right: t.pos * (t.end.right - t.start.right) + t.start.right,
                bottom: t.pos * (t.end.bottom - t.start.bottom) + t.start.bottom,
                left: t.pos * (t.end.left - t.start.left) + t.start.left
            })
        }, C = {}, u.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function (e, t) {
            C[t] = function (t) {
