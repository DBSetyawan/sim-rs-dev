...
!(function(a, b) {
      ...
      o.extend({
        ...
        map: function(a, b, c) {
          var d,
            ...
            g = 0,
            h = [];
          if (t(a)) for (d = a.length; d > g; g++) (e = b(a[g], g, c)), null != e && h.push(e);
    ...
    function ka(a, b, c, d, e) {
      for (
        var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, p = a.length;
        p > n;
        n++
      )
        if (((f = a[n]), f || 0 === f))
    ...
    o.extend({
      ...
      clone: function(a, b, c) {
        ...
        if (b)
          if (c) for (f = f || ha(a), g = g || ha(h), d = 0, e = f.length; e > d; d++) Aa(f[d], g[d]);
          else Aa(a, h);
    ...
    function _a(a, b, c) {
      for (
        var d, e = (cb.tweeners[b] || []).concat(cb.tweeners['*']), f = 0, g = e.length;
        g > f;
        f++
      )
    ...
    function ab(a, b, c) {
      ...
      if (((i = !o.isEmptyObject(b)), i || !o.isEmptyObject(n))) {
        ...
        for (d in n)
          i ||
            (r ? 'hidden' in r && (q = r.hidden) : (r = R.access(a, 'fxshow', { display: j })),
            f && (r.hidden = !q),
            q && ca([a], !0),
            m.done(function() {
        ...
        stop: function(a, b, c) {
          ...
          return (
            ...
            this.each(function() {
              ...
              else for (e in g) g[e] && g[e].stop && Xa.test(e) && d(g[e]);
              for (e = f.length; e--; )
                f[e].elem !== this ||
                  (null != a && f[e].queue !== a) ||
    ...
    function Kb(a, b, c, d) {
      ...
      else for (e in b) Kb(a + '[' + e + ']', b[e], c, d);
    }
