            ...
            load: function() {
              ...
              if ($image.prev('.magnify-lens').length) {
                $container
                  ...
                  .css('background-image', "url('" + sImgSrc + "')");
              } else {
                $image.before(
              ...
              $container.on('mousemove touchmove', function(e) {
                ...
                if ($lens.is(':visible')) {
                  ...
                  if (nMagnifiedWidth && nMagnifiedHeight) {
                    ...
                    var nRatioX =
                        Math.round((nX / nImageWidth) * nMagnifiedWidth - nLensWidth / 2) * -1,
                      nRatioY =
                        Math.round((nY / nImageHeight) * nMagnifiedHeight - nLensHeight / 2) * -1,
