    ...
    _build: function() {
      ...
      if (
        ...
        a.each(this.options.buttons, function(b, c) {
          var e = a('<button/>')
            .addClass(c.addClass ? c.addClass : 'gray')
            .html(c.text)
            .attr('id', c.id ? c.id : 'button-' + b)
            .attr('title', c.title)
            .appendTo(d.$bar.find('.noty_buttons'))
            .on('click', function(b) {
    ...
    show: function() {
      ...
      return (
        ...
        a.inArray('click', b.options.closeWith) > -1 &&
          b.$bar.css('cursor', 'pointer').one('click', function(a) {
            b.stopPropagation(a),
        ...
        'string' == typeof b.options.animation.open
          ? (b.$bar.css('height', b.$bar.innerHeight()),
      ...
      'object' === a.type(b)
        ? b.options.dismissQueue
          ? b.options.maxVisible > 0
            ? a(b.options.layout.container.selector + ' > li').length < b.options.maxVisible &&
              a.notyRenderer.show(a.noty.queue.shift())
            : a.notyRenderer.show(a.noty.queue.shift())
          : a.noty.ontap && (a.notyRenderer.show(a.noty.queue.shift()), (a.noty.ontap = !1))
        : (a.noty.ontap = !0);
    }),
      ...
      b.options.modal && (a.notyRenderer.createModalFor(b), a.notyRenderer.setModalCount(1)),
        b.options.custom
          ? 0 == b.options.custom.find(b.options.layout.container.selector).length
            ? b.options.custom.append(a(b.options.layout.container.object).addClass('i-am-new'))
            : b.options.custom.find(b.options.layout.container.selector).removeClass('i-am-new')
            ...
            switch (this.options.layout.name) {
              ...
              case 'inline':
                a(b).css({ borderRadius: '0px 0px 0px 0px' }),
                  a(b)
                    .first()
                    .css({ 'border-top-left-radius': '5px', 'border-top-right-radius': '5px' }),
                  a(b)
                    .last()
                    .css({
