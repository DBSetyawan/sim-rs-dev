/*! jQuery v3.0.0-beta1 | (c) jQuery Foundation | jquery.org/license */ !(function (a, b) {
    ...
    o.extend({
            ...
            makeArray: function (a, b) {
                var c = b || [];
                return (
                    null != a && (t(Object(a)) ? o.merge(c, 'string' == typeof a ? [a] : a) : g.call(c, a)), c
                );
            },
    ...
    var B,
        ...
        D = (o.fn.init = function (a, b, c) {
            ...
            if (((c = c || B), 'string' == typeof a)) {
                if (
                    ((e =
                            '<' === a[0] && '>' === a[a.length - 1] && a.length >= 3 ? [null, a, null] : C.exec(a)),
                        !e || (!e[1] && b))
                )
                ...
                if (e[1]) {
                    if (
                        ((b = b instanceof o ? b[0] : b),
                            o.merge(this, o.parseHTML(e[1], b && b.nodeType ? b.ownerDocument || b : d, !0)),
                            y.test(e[1]) && o.isPlainObject(b))
                    )
                        for (e in b) o.isFunction(this[e]) ? this[e](b[e]) : this.attr(e, b[e]);
                    return this;
                }
                                ...
                                o.each(c, function (c, d) {
                                        ...
                                        f[d[1]](function () {
                                            ...
                                            a && o.isFunction(a.promise) ?
                                                ...
                                                .done(b.resolve)
                                                .fail(b.reject) :
                                                b[d[0] + 'With'](this === e ? b.promise() : this, g ? [a] : arguments);
                                        });
                                    }),
                                    (a = null);
                            })
                        ...
                        function h(b, c, d, f) {
                            return function () {
                                    ...
                                    k = function () {
                                        ...
                                        if (!(g > b)) {
                                            ...
                                            o.isFunction(e) ?
                                                ...
                                                (g++, e.call(a, h(g, c, J, f), h(g, c, K, f), h(g, c, J, c.notify))) :
                                                (d !== J && ((i = void 0), (j = [a])),
                                ...
                                b
                                    ?
                                    l() :
                                    (o.Deferred.getStackHook && (l.stackTrace = o.Deferred.getStackHook()),
                                        a.setTimeout(l));
                            };
                        }
                        return o
    ...
    o.extend({
        ...
        ready: function (a) {
            ...
            ((o.isReady = !0), (a !== !0 && --o.readyWait > 0) || M.resolveWith(d, [o]));
        },
    });
    ...
    (o.ready.promise = function (b) {
        return (
            ...
            ((M = o.Deferred()),
                ...
                (d.addEventListener('DOMContentLoaded', N), a.addEventListener('load', N))),
            M.promise(b)
        );
    }),
    o.ready.promise();
    ...
    (Q.prototype = {
        ...
        set: function (a, b, c) {
            ...
            if ('string' == typeof b) e[o.camelCase(b)] = c;
                ...
                for (d in b) e[o.camelCase(d)] = b[d];
            return e;
        },
        get: function (a, b) {
                ...
                if (void 0 === a) {
                    if (this.length && ((e = S.get(f)), 1 === f.nodeType && !R.get(f, 'hasDataAttrs'))) {
                        ...
                        while (c--)
                            g[c] &&
                            ((d = g[c].name),
                                0 === d.indexOf('data-') && ((d = o.camelCase(d.slice(5))), V(f, d, e[d])));
        ...
        o.extend({
            queue: function (a, b, c) {
                ...
                return a ?
                    ((b = (b || 'fx') + 'queue'),
                        (d = R.get(a, b)),
                        c && (!d || o.isArray(c) ? (d = R.access(a, b, o.makeArray(c))) : d.push(c)),
                        d || []) :
                    void 0;
            },
    ...
    function ca(a, b) {
        for (var c, d, e = [], f = 0, g = a.length; g > f; f++)
            ...
            ((c = d.style.display),
                b ?
                ('none' === c &&
                    ((e[f] = R.get(d, 'display') || null), e[f] || (d.style.display = '')),
                    '' === d.style.display &&
    ...
    function ka(a, b, c, d, e) {
        for (
            var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, p = a.length; p > n; n++
        )
            if (((f = a[n]), f || 0 === f))
        ...
        while ((f = m[n++]))
            ...
            ((j = o.contains(f.ownerDocument, f)), (g = ha(l.appendChild(f), 'script')), j && ia(g), c)
        ) {
            k = 0;
    ...
    (o.event = {
        ...
        remove: function (a, b, c, d, e) {
            ...
            if (r && (i = r.events)) {
                ...
                while (j--)
                    if (
                        ((h = na.exec(b[j]) || []), (n = q = h[1]), (p = (h[2] || '').split('.').sort()), n)
                    ) {
                        (l = o.event.special[n] || {}),
            ...
            if (
                ...
                while ((f = h[b++]) && !a.isPropagationStopped()) {
                    ...
                    while ((g = f.handlers[c++]) && !a.isImmediatePropagationStopped())
                        ...
                        ((a.handleObj = g),
                            (a.data = g.data),
                            (d = ((o.event.special[g.origType] || {}).handle || g.handler).apply(f.elem, i)),
    ...
    function Ca(a, b, c, d) {
        ...
        if (
            ...
            for (h = o.map(ha(e, 'script'), ya), i = h.length; p > n; n++)
                (j = e),
                n !== q && ((j = o.clone(j, !0, !0)), i && o.merge(h, ha(j, 'script'))),
                c.call(a[n], j, n);
            if (i)
                for (k = h[h.length - 1].ownerDocument, o.map(h, za), n = 0; i > n; n++)
                    ...
                    o.contains(k, j) &&
                    (j.src ? o._evalUrl && o._evalUrl(j.src) : m(j.textContent.replace(wa, ''), k));
        }
        return a;
    }
    ...
    function Da(a, b, c) {
        for (var d, e = b ? o.filter(b, a) : a, f = 0; null != (d = e[f]); f++)
            ...
            d.parentNode &&
            (c && o.contains(d.ownerDocument, d) && ia(ha(d, 'script')), d.parentNode.removeChild(d));
        return a;
    }
    o.extend({
            ...
            clone: function (a, b, c) {
                ...
                if (!(l.noCloneChecked || (1 !== a.nodeType && 11 !== a.nodeType) || o.isXMLDoc(a)))
                    for (g = ha(h), f = ha(a), d = 0, e = f.length; e > d; d++) Ba(f[d], g[d]);
                if (b)
                    if (c)
                        for (f = f || ha(a), g = g || ha(h), d = 0, e = f.length; e > d; d++) Aa(f[d], g[d]);
                    else Aa(a, h);
            ...
            cleanData: function (a) {
                for (var b, c, d, e = o.event.special, f = 0; void 0 !== (c = a[f]); f++)
                    if (P(c)) {
                        if ((b = c[R.expando])) {
                            if (b.events)
                                for (d in b.events) e[d] ? o.event.remove(c, d) : o.removeEvent(c, d, b.handle);
                            c[R.expando] = void 0;
                        }
    ...
    function Ra(a, b, c, d, e) {
        for (var f = c === (d ? 'border' : 'content') ? 4 : 'width' === b ? 1 : 0, g = 0; 4 > f; f += 2)
            ...
            ((g += o.css(a, 'padding' + Y[f], !0, e)),
                'padding' !== c && (g += o.css(a, 'border' + Y[f] + 'Width', !0, e)));
        return g;
    }
            ...
            style: function (a, b, c, d) {
                if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                    ...
                    return (
                        ...
                        i[b] :
                        ((f = typeof c),
                            'string' === f && (e = X.exec(c)) && e[1] && ((c = _(a, b, e)), (f = 'number')),
                            null != c &&
                            c === c &&
                            ('number' === f && (c += (e && e[3]) || (o.cssNumber[h] ? '' : 'px')),
                                l.clearCloneStyle ||
                                '' !== c ||
    ...
    (Ta.prototype = {
        ...
        run: function (a) {
            ...
            return (
                (this.pos = this.options.duration ? o.easing[this.easing](a) : a),
    ...
    function _a(a, b, c) {
        for (
            var d, e = (cb.tweeners[b] || []).concat(cb.tweeners['*']), f = 0, g = e.length; g > f; f++
        )
        ...
        if (((i = !o.isEmptyObject(b)), i || !o.isEmptyObject(n))) {
            l &&
                ...
                ((c.overflow = [p.overflow, p.overflowX, p.overflowY]),
                    (j = r && r.display),
                    null == j && (j = R.get(a, 'display')),
                    (k = o.css(a, 'display')),
                    'none' === k &&
                    (j ?
                        (k = j) :
                        (ca([a], !0), (j = a.style.display || j), (k = o.css(a, 'display')), ca([a]))),
            ...
            for (d in n)
                i ||
                (r ? 'hidden' in r && (q = r.hidden) : (r = R.access(a, 'fxshow', {
                        display: j
                    })),
                    f && (r.hidden = !q),
                    q && ca([a], !0),
                ...
                d in r ||
                ((r[d] = i.start),
                    q && ((i.end = i.start), (i.start = 'width' === d || 'height' === d ? 1 : 0)));
        }
    }
    ...
    function cb(a, b, c) {
        ...
        for (bb(k, j.opts.specialEasing); g > f; f++)
            if ((d = cb.prefilters[f].call(j, a, k, j.opts)))
                return (
                    o.isFunction(d.stop) && (o._queueHooks(j.elem, j.opts.queue).stop = o.proxy(d.stop, d)), d
                );
        return (
            o.map(k, _a, j),
                ...
                return (
                    ...
                    this.each(function () {
                        ...
                        if (e) g[e] && g[e].stop && d(g[e]);
                            ...
                            for (e in g) g[e] && g[e].stop && Xa.test(e) && d(g[e]);
                        for (e = f.length; e--;)
                            f[e].elem !== this ||
                            (null != a && f[e].queue !== a) ||
        ...
        (o.fx.start = function () {
            Va ||
                (Va = a.requestAnimationFrame ?
                    ...
                    a.setInterval(o.fx.tick, o.fx.interval));
        }),
        (o.fx.stop = function () {
            ...
            attr: function (a, b, c) {
                ...
                if (3 !== f && 8 !== f && 2 !== f)
                    return 'undefined' == typeof a.getAttribute ?
                        ...
                        ((1 === f && o.isXMLDoc(a)) ||
                            ((b = b.replace(fb, gb)),
                                (e = o.attrHooks[b] || (o.expr.match.bool.test(b) ? db : void 0))),
                            void 0 !== c ?
                            null === c ?
    ...
    o.fn.extend({
        ...
        o.extend({
            prop: function (a, b, c) {
                ...
                if (3 !== f && 8 !== f && 2 !== f)
                    return (
                        (1 === f && o.isXMLDoc(a)) || ((b = o.propFix[b] || b), (e = o.propHooks[b])),
                        void 0 !== c ?
                        e && 'set' in e && void 0 !== (d = e.set(a, c, b)) ?
                        d :
                        (a[b] = c) :
    ...
    o.fn.extend({
        ...
        hasClass: function (a) {
            ...
            b = ' ' + a + ' ';
            while ((c = this[d++]))
                if (1 === c.nodeType && (' ' + kb(c) + ' ').replace(jb, ' ').indexOf(b) > -1) return !0;
            return !1;
        },
    });
    var lb = /\r/g;
    ...
    (o.parseXML = function (b) {
        ...
        return (
            (!c || c.getElementsByTagName('parsererror').length) && o.error('Invalid XML: ' + b), c
        );
    });
    var qb = /%20/g,
        rb = /#.*$/,
    ...
    o.extend({
            ...
            ajax: function (b, c) {
                ...
                if (
                    (s.promise(y),
                        (p.url = ((b || p.url || nb.href) + '').replace(wb, nb.protocol + '//')),
                ...
                l && 0 === o.active++ && o.event.trigger('ajaxStart'),
                    ...
                    (p.data = p.data.replace(qb, '+')) :
                    ((n = p.url.slice(f.length)),
                        p.data && ((f += (pb.test(f) ? '&' : '?') + p.data), delete p.data),
                        p.cache === !1 &&
                        ((f = f.replace(sb, '')), (n = (pb.test(f) ? '&' : '?') + '_=' + ob++ + n)),
                        (p.url = f + n)),
                    p.ifModified &&
                    (o.lastModified[f] && y.setRequestHeader('If-Modified-Since', o.lastModified[f]),
                        o.etag[f] && y.setRequestHeader('If-None-Match', o.etag[f])),
                    ((p.data && p.hasContent && p.contentType !== !1) || c.contentType) &&
                    y.setRequestHeader('Content-Type', p.contentType),
                    y.setRequestHeader(
                        'Accept',
                        p.dataTypes[0] && p.accepts[p.dataTypes[0]] ?
                        p.accepts[p.dataTypes[0]] + ('*' !== p.dataTypes[0] ? ', ' + zb + '; q=0.01' : '') :
                        p.accepts['*'],
                    );
                ...
                function A(b, c, d, h) {
                    ...
                    k ||
                        ((k = !0),
                            ...
                            (y.status = b),
                            (y.statusText = (c || x) + ''),
                            j ? s.resolveWith(q, [m, x, y]) : s.rejectWith(q, [y, x, n]),
                            y.statusCode(u),
                            (u = void 0),
                            l && r.trigger(j ? 'ajaxSuccess' : 'ajaxError', [y, p, j ? m : n]),
                            t.fireWith(q, [y, x]),
                            l && (r.trigger('ajaxComplete', [y, p]), --o.active || o.event.trigger('ajaxStop')));
                }
                return y;
            },
    ...
    function Kb(a, b, c, d) {
        ...
        if (o.isArray(b))
            o.each(b, function (b, e) {
                c || Gb.test(a) ?
                    d(a, e) :
                    Kb(a + '[' + ('object' == typeof e && null != e ? b : '') + ']', e, c, d);
            });
    ...
    o.ajaxSetup({
        ...
        o.ajaxPrefilter('json jsonp', function (b, c, d) {
            ...
            return h || 'jsonp' === b.dataTypes[0] ?
                ((e = b.jsonpCallback = o.isFunction(b.jsonpCallback) ?
                        ...
                        b.jsonpCallback),
                    h ?
                    (b[h] = b[h].replace(Ob, '$1' + e)) :
                    b.jsonp !== !1 && (b.url += (pb.test(b.url) ? '&' : '?') + b.jsonp + '=' + e),
        ...
        (o.parseHTML = function (a, b, c) {
            ...
            return e ?
                [b.createElement(e[1])] :
                ((e = ka([a], b, f)), f && f.length && o(f).remove(), o.merge([], e.childNodes));
        }),
        (o.fn.load = function (a, b, c) {
            var d,
                ...
                h = a.indexOf(' ');
            return (
                h > -1 && ((d = o.trim(a.slice(h))), (a = a.slice(0, h))),
                ...
                if (this[0]) {
                    ...
                    return (
                        ...
                        ((a = this.offsetParent()),
                            ...
                            (d.left += o.css(a[0], 'borderLeftWidth', !0) - a.scrollLeft())), {
