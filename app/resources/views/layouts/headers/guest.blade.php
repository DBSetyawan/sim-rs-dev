                        ...
                        <div class="col-lg-5 col-md-7">
                            <div class="card bg-gradient-yellow shadow border-0">
                                <div class="card-header bg-transparent pb-5">
                                    <div class="text-muted text-center mt-2 mb-3"><small><img src="{{ asset('argon') }}/img/logoKOPfooter.PNG" width="11%" height="7%" rel="icon" type="image/png" alt=""> <b class="text-muted col-md-5">{{ __('KOP SAIM-v2.1') }}</b></small></div>
                                    <div class="btn-wrapper text-center">
                                        ...
                                        <small>
                                            ...
                                            <br>
                                            <strong>Live - SAIM application v2.1</strong>
                                        </small>
                                    </div>
                                </div>
