...
<body data-controller="boxdesigner" style="position: sticky;top: 0px; height:100px;padding-bottom:0px;padding-top:0px;" data-action="new" class="boxdesigner" id="new" data-csrf="OiQPH0s_OQV9JSlYfxwvACs7HTleEjQ7KMzg3oc_OBO3L1KEArHloJNo">
                  ...
                  <li class="nav-bar__item nav-bar__item--dropdown mobile-dropdown-js dropdown-notifications">
                    ...
                    <ul class="nav-dropdown">
                      <a class="nav-dropdown__link text-center justify-items-start hover:justify-items-left" id="ntfound" href="#">
                        ...
                        <span style="font-size: 15px;position: relative; top: -14px; left:7px">Empty Notification..</span>
                      </a>
                    </ul>
                </li>
                @endauth
  ...
  <div class="px-4 lg:px-16 xl:px-32">
    ...
    <a href="{{ url('/') }}"><i class="fas fa-arrow-circle-left" style='height: 3%; width: 3%; object-fit: contain'></i></a> 
                    ...
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                      <div class="md:col-span-1">
                        <div class="px-4 sm:px-0">
                          <h3 class="text-lg font-medium leading-6 text-gray-900">Ticket new</h3>
                          <p class="mt-1 text-sm text-gray-600">
                            Create a custom message to show your attendees after they complete a purchase, and on their confirmation email.
                          </p>
                        </div>
                      </div>
                      <div class="mt-5 md:mt-0 md:col-span-2">
                        ...
                        @endif
                        <form action="{{ route('store.new.tickets') }}" class="form-horizontal" role="form" method="POST">
                          {!! csrf_field() !!}
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                              <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-4">
                                  ...
                                  <input type="text" name="title" required id="title" autocomplete="email" style="background-color: rgb(238, 238, 238);" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                @if ($errors->has('title'))
                                ...
                                <div class="col-span-6 sm:col-span-3 {{ $errors->has('category') ? ' has-error' : '' }}">
                                  <label for="category" class="block text-sm font-medium text-gray-700">Category Ask</label>
                                ...
                                <div class="col-span-6 sm:col-span-3 {{ $errors->has('priority') ? ' has-error' : '' }}">
                                ...
                                <div class="mt-5 md:mt-0 md:col-span-2 {{ $errors->has('message') ? ' has-error' : '' }}">
                                  <textarea id="message" required name="message" rows="9" style="width:322px"
                                  class="shadow-sm focus:ring-indigo-500 mt-10 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="enter few words to reply message.."></textarea>
                                </div>
                                <p style="width: 210px">
                                  Ticket message reply scope
                                </p>
                              </div>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="contact-details">
          ...
          <ul class="contact">
            <li><p><i class="fa fa-map-marker"></i> <strong>@lang('footer.address'):</strong> Jln. Rungkut Industri III / 19, Surabaya 60293, East Java - Indonesia</p></li>
            <li><p><i class="fa fa-phone"></i> <strong>@lang('footer.phone'):</strong> (031) 8438182</p></li>
          ...
          const team_support = `{{ Auth::user()->accessable }}`;
            ...
            const channels_ticketingreplys = pusher.subscribe('re-kop-ticketing');
             channels_ticketingreplys.bind('received-reply-ticketing', function(data) {
                  ...
                  $('#ntfound').hide();
                  var existingNotifications = notifications.html();
                  let ticket_id = `${data[0].ticket.ticket_id}`;
                  var url = '{{ route("show.tickets", ":ticket_id") }}';
                  url = url.replace(':ticket_id', ticket_id);
                  ...
                  <a class="nav-dropdown__link" href="${url}">
                    ...
                    <span class="material-icons">
                      ...
                      Reply Your Ticket : #${data.ticket_title}
                  </a>`;
