...
<script id="packlane-globals" src="{{ asset('js/store-init.js') }}"></script>
  ...
  <body data-controller="boxdesigner" style="position: sticky;top: 0px; height:100px;padding-bottom:0px;padding-top:0px;" data-action="new" class="boxdesigner" id="new" data-csrf="OiQPH0s_OQV9JSlYfxwvACs7HTleEjQ7KMzg3oc_OBO3L1KEArHloJNo">
    <header class="header " id="main-header-js" style="position: sticky;top: 0px; height:100px;padding-bottom:0px;padding-top:0px;">
        <div class="nav-container" style="position: sticky;top: 0px;height: 47px;padding-bottom:0px;padding-top:0px;background: rgb(255, 255, 255);">
  ...
  <div class="px-4 lg:px-16 xl:px-32">
    ...
    <a href="{{ route('index.tickets') }}"><i class="fas fa-arrow-circle-left" style='height: 3%; width: 3%; object-fit: contain'></i></a> 
     <div class="container mx-auto">
      <div class="col-md-1">
          {{-- <img alt="KOP" class="img-responsive" style='height: 8%; width: 8%; object-fit: contain' src="{{ asset('img/box.png') }}"> --}}
      </div>
      <div class="w-auto flext justify-items-center""> 
...
<div class="bg-white shadow overflow-hidden sm:rounded-lg w-full">
    <div class="px-4 py-5 sm:px-6 bg-violet-200 rounded-md">
      <h3 class="text-lg leading-6 font-medium text-gray-900">
        Applicantion Ticket - Information 
      </h3>
      <p class="mt-1 max-w-2xl text-sm text-gray-500">
        Personal details for ticketing #{{ $ticket->title }}
      </p>
    </div><br/>
    <div class="border-t border-gray-200">
      <dl>
        ...
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          ...
          <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
            @php
              $date = \Carbon\Carbon::parse($ticket->created_at)->locale(Config::get('languages')[App::getLocale()]['flag-icon']);
        ...
        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
          {{-- <dt class="text-sm font-medium text-gray-500">
            Ticket reply message table of contents
          </dt> --}}
            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
              <ul role="list" class="border border-gray-200 rounded-md divide-y divide-gray-200">
                <li class="pl-3 pr-4 py-3 flex items-right justify-between text-sm">
                  <div class="w-0 flex-1 flex items-right" style="">
                    <span class="ml-2 flex-1 w-5/6 truncate">
                    ...
                    <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                      <div class="w-0 flex-1 flex items-center">
                        <span class="ml-2 flex-1 w-4/5 truncate">
                          @include('tickets.reply', ['tickets' => $ticket->status])
                        </span>
                        </div>
                      </li>
                    </ul>
...
@if($fdatxa >= 1 && $fdatxa <= 10)
  <div style="margin-bottom: 2500px;"></div>
  @elseif($fdatxa >= 11 && $fdatxa <= 25)
<div style="margin-bottom: 6500px;"></div>
@elseif($fdatxa >= 26 && $fdatxa <= 40)
<div style="margin-bottom: 7450px;"></div>
@else 
<div style="margin-bottom: 285px;"></div>
@endif
<footer id="footer">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="contact-details">
          <h4>Contact Us</h4>
          <ul class="contact">
            <li><p><i class="fa fa-map-marker"></i> <strong>Address:</strong> <span id="show_tickets_address_footer"></p></li>
            <li><p><i class="fa fa-phone"></i> <strong>Phone:</strong> <span id="show_tickets_phone_footer"></p></li>
            <li><p><i class="fa fa-fax"></i> <strong>Fax:</strong> <span id="show_tickets_fax_footer"></p></li>
            <li><p><i class="fa fa-envelope"></i> <strong>Email:</strong> <a href="mailto:printing@krisanthium.com"> <span id="show_tickets_email_footer"></a></p></li>
            <li><p><i class="fa fa-external-link-square"></i> <strong>URL:</strong> <a href="{{ route('dashboard') }}"> <span id="show_tickets_url_footer"></a></p></li>
          </ul>
        </div>
      </div>
    </div>
...
var pusher = new Pusher('fdd3c469ca4993da4280', {
    ...
    RenderAPIAboutCompany().then(function(data){
      $('#show_tickets_address_footer').append(data.data.address)
      $('#show_tickets_phone_footer').append(data.data.phone)
      $('#show_tickets_fax_footer').append(data.data.Fax)
      $('#show_tickets_email_footer').append(data.data.Email)
      $('#show_tickets_url_footer').append(data.data.URL)
    });
