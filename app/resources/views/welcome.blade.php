                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 col-md-6">
                        {{-- @extends('layouts.headers.guest') --}}
                            <img src="{{ asset('argon') }}/img/logoKOPfooter.PNG" width="35%" height="32%" rel="icon" type="image/png" alt="">
                            <div class="card-body">
                            ...
                            @endauth
                            @guest
                                <a href="https://vpn.krisanthium.com:7070/saims-application/public/login" class="btn btn-warning stretched-link"><label class="">Authenticated required</label></a>
                            @endguest
                        </div>
                    </div>
                </div>
