...
<html lang="id">
  <head>
    ...
    <link rel="stylesheet" href="packlane-assets/flag-icons-main/css/flag-icons.css">
    <link rel="stylesheet" href="packlane-assets/flag-icons-main/css/flag-icons.min.css">
                ...
                @auth
                  <li class="nav-bar__item nav-bar__item--dropdown mobile-dropdown-js ">
                    ...
                    @if(Auth::user()->accessable == "marketing")                    
                      ...
                      <a class="nav-dropdown__link" href="{{ route('tb.orders.customers') }}"><i class="fas fa-shopping-cart"></i> {{ __('History Transaction') }}</a>
                        @else  
                        <a class="nav-dropdown__link" href="{{ route('accounts.id') }}"><i class="fas fa-user-circle"></i> @lang('message.usernames'), {{ Auth::user()->name }}</a>
    ...
    <div class="container">
      <div class="row">
          <div class="col-md-8 col-md-offset-2">
            ...
            <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
              <!--Card 1-->
              @if(Auth::user()->accessable == "admin" || Auth::user()->accessable == "marketing")
              <div class="rounded overflow-hidden shadow-lg bg-emerald-300">
                <div class="px-6 py-4">
                  <div class="font-bold text-xl mb-2">
                    <span class="material-icons">
                      add_circle
                    </span>
                    <a href="{{ route('index.tickets') }}">@lang('message.tckt')</a>
                  </div>
                  <p class="text-gray-700 text-base">
                    @lang('message.ticketlist')
                  </p>
                </div>
                <div class="px-6 pt-4 pb-2">
                  <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Support</span>
                  <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Delivered</span>
                  <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Printing</span>
                  <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Packaging</span>
              ...
              <div class="rounded overflow-hidden shadow-lg bg-emerald-300">
                <div class="px-6 py-4">
                  ...
                  <p class="text-gray-700 text-base">
                  Submitting questions, you can ask questions here.
                  </p>
                </div>
                <div class="px-6 pt-4 pb-2">
                    <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Question</span>
                    <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Support</span>
                    <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Ticket</span>
                  </div>
                </div>
              @else 
              <div class="rounded overflow-hidden shadow-lg bg-emerald-300">
                <div class="px-6 py-4">
                  <div class="font-bold text-xl mb-2">
                    <span class="material-icons">
                      ...
                      <a href="{{ route('my_tickets') }}">@lang('message.tckt')</a>
                  </div>
                  <p class="text-gray-700 text-base">
                    @lang('message.ticketlist')
                  </p>
                ...
                <div class="px-6 py-4">
                  <div class="font-bold text-xl mb-2">
                    <span class="material-icons">
                      ...
                      <a href="{{ route('new.form.tickets') }}">
                    @lang('message.tcktnew')</a></div>
                  <p class="text-gray-700 text-base">
                    @lang('message.tcktsubmiting')
                  </p>
                </div>
      ...
      <div class="py-4"> 
        <div class="flex justify-center">
          <livewire:search-component-customers/> 
        </div>
      </div>
...
<span class="tool-_disclaimer" style="color: #8189a7;font-size: 13px;
  ...
  <div style="margin-bottom: 845px;"></div>
<footer id="footer">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="contact-details">
          ...
          <ul class="contact">
            <li><p><i class="fa fa-map-marker"></i> <strong>@Lang('footer.address'):</strong> <span id="secret_address_footer"></p></li>
            <li><p><i class="fa fa-phone"></i> <strong>@lang('footer.phone'):</strong> <span id="secret_phone_footer"></p></li>
            <li><p><i class="fa fa-fax"></i> <strong>Fax:</strong> <span id="secret_fax_footer"></p></li>
            <li><p><i class="fa fa-envelope"></i> <strong>Email:</strong> <a href="mailto:printing@krisanthium.com"> <span id="secret_email_footer"></a></p></li>
            <li><p><i class="fa fa-external-link-square"></i> <strong>URL:</strong> <a href="{{ route('dashboard') }}"> <span id="secret_url_footer"></a></p></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    @auth
      ...
      var pusher = new Pusher('fdd3c469ca4993da4280', {
          ...
          const team_support = `{{ Auth::user()->accessable }}`;
            ...
            const channelsPayment = pusher.subscribe('payment-transaction');

            channelsPayment.bind('notify-midtran', function(data) {
              console.log(data);
            });
      
    @endauth

    Livewire.on("Midtrans", () => {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                          ...
                          function changeResult(type,data){
                            Swal.fire(
                                'Information!',
                                'Response : '+ JSON.stringify(data) + 'Type : '+type,
                                'warning'
                            )
                          }
                          snap.pay(data, {
                            onSuccess: function(result){
                              ...
                              Swal.fire(
                                  'Information!',
                                  'Response : '+ JSON.stringify(result.status_message),
                                  'warning'
                              )
                            },
...
RenderAPIAboutCompany().then(function(data){
  ...
  if(data){
      $('#secret_address_footer').append(data.data.address)
      $('#secret_phone_footer').append(data.data.phone)
      $('#secret_fax_footer').append(data.data.Fax)
      $('#secret_email_footer').append(data.data.Email)
      $('#secret_url_footer').append(data.data.URL)
    }
  });
