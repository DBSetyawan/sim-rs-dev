<div class="flex space-x-1 justify-around">
    <a href="{{ route('detail.orders.customers', [$assets_uid]) }}" target="_blank" class="p-1 text-teal-600 hover:bg-teal-600 hover:text-white rounded">
    ...
    {{-- <x-modal :value="$id">
        ...
        <h1 class="text-2xl text-purple-700">{{ $assets_uid }}</h1>
    </x-modal>
