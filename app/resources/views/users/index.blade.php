<html lang="en"><head>
    ...
    <title>{{ config('app.name', 'SAIM application') }}</title>
    <!-- Favicon -->
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                    ...
                    <img alt="Image placeholder" src="{{ URL::asset('argon') }}/img/theme/team-1-800x800.jpg">
                    </span>
                </div>
            </a>
                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('create.users') }}" class="btn btn-sm btn-primary">Add user</a>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                          @foreach($user as $users)
                                <tr>
                                    <td>{{ $users->name }}</td>
                                    <td>
                                        <a href="mailto:admin@argon.com">{{ $users->email }} </a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item" href="{{ route('users.destroy', ['id'=>$users->id]) }}">hapus</a>
                                                    <a class="dropdown-item" href=" {{ route('users.edit', ['id' => $users->id]) }}">Ubah</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
